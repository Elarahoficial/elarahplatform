document.addEventListener('DOMContentLoaded', () => {
  ...
  const experiences = [
    ...
    { data: "11/04", categoria: "Vela", nome: "Vela + Home Spray (Clássico)", horario: "10h30 – 11h30", duracao: "1h", bairro: "Brooklin", endereco: "Rua Nova York, 345 – São Paulo", inclui: "Coffee break", preco: "R$180", cor: "#f6e6a8,#e0c05e", imagem: "assets/experiences/vela-cafe.jpg" },
