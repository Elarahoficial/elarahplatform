document.addEventListener('DOMContentLoaded', () => {
  ...
  const experiences = [
    ...
    { data: "11/04", categoria: "Vela", nome: "Vela + Home Spray (Clássico)", horario: "10h30 – 11h30", duracao: "1h", bairro: "Brooklin", endereco: "Rua Nova York, 345 – São Paulo", inclui: "Coffee break", preco: "R$180", cor: "#f6e6a8,#e0c05e", imagem: "assets/experiences/churrasco.jpg" },
    ...
    { data: "11/04", categoria: "Vela", nome: "Vela + Home Spray (Floral)", horario: "15h30 – 17h00", duracao: "1h30", bairro: "Brooklin", endereco: "Rua Nova York, 345 – São Paulo", inclui: "Coffee break", preco: "R$180", cor: "#f6e6a8,#e0c05e", imagem: "assets/experiences/vela-praia.jpg" },
    { data: "11/04", categoria: "Pintura", nome: "Pintura em Taça", horario: "10h30 – 12h30", duracao: "2h", bairro: "Brooklin", endereco: "Rua Indiana, 669 – São Paulo", inclui: "Vinho à vontade", preco: "R$262", cor: "#f9d1d1,#e07a7a", imagem: "assets/experiences/vela-floral.jpg" },
