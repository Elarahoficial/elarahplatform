...
planos = f'''
  <section class="slide">
    ...
    <div class="note" style="margin-top:18px">◆ Valores <b>por pessoa</b>, com material e condução inclusos. Cada nível soma <b>+R$ 100</b> (foto profissional e, no Completo, personalização &amp; lembrancinha). A <b>palestra de Setembro Amarelo</b> é combinada à parte, conforme o tema e o número de participantes. Realizado na empresa ou em espaço parceiro.</div>
    {foot("Investimento")}
  </section>'''
