...
# ---- recolor CSS to elegant blush rose + deep plum (50 anos · flores) ----
head = head.replace("--orange:#F27623;", "--orange:#C06C86;")       # accent: rose
head = head.replace("--orange-dark:#D4600E;", "--orange-dark:#9C4C67;")
head = head.replace("--navy:#16233C;", "--navy:#452C3B;")           # deep plum/aubergine (headings/dark)
head = head.replace("--navy-soft:#3B4E6B;", "--navy-soft:#6E5661;")  # muted mauve for lead
head = head.replace("--blue-accent:#4C6EA3;", "--blue-accent:#C06C86;")
head = head.replace("#EDF1F7", "#F6EDF0").replace("#DCE5F1", "#EAD8DE")
head = head.replace("#FF9A4D", "#D897A6")
head = head.replace("rgba(242,118,35,.22)", "rgba(192,108,134,.26)")
head = head.replace(".itable .hl{background:#F7EAEF}", ".itable .hl{background:#F3E7EC}")  # soft blush highlight
head = head.replace(".tier.hl{border:2px solid var(--navy);background:#FBEBDF}", ".tier.hl{border:2px solid var(--navy);background:#F3E7EC}")
  ...
  <section class="slide">
    <div class="slide__head">
      ...
      <div class="head-right">
        <span class="kicker">Proposta de aniversário · 50 anos</span>
        <span class="compass">50 <span>anos</span><small>manhã · 19 ou 26 de setembro</small></span>
      </div>
    </div>
    <div class="cover">
      <div>
        <span class="eyebrow">✦ Experiência · 50 anos</span>
        <h1>Uma manhã <br><em>entre flores</em></h1>
        <p class="lead">Uma comemoração <strong>delicada e cheia de afeto</strong> pra celebrar os 50 anos com as mulheres que ela ama — uma oficina <strong>floral e sensorial</strong>, em que cada uma cria a sua peça e leva pra casa de recordação. 🌸</p>
        <div class="rule"></div>
        <div class="chips">
          <span class="chip"><b>15 a 20</b> mulheres</span>
          <span class="chip">Manhã · <b>19 ou 26/09</b></span>
          <span class="chip">A partir de <b>R$ 229</b></span>
        </div>
      </div>
      <div class="cover-photo">
        <img src="assets/buque.jpg" alt="Mãos segurando um arranjo de flores delicado e elegante" style="object-position:center 45%">
      </div>
    </div>
    {foot("Experiência · 50 anos")}
  </section>'''
...
buscamos = f'''
  <section class="slide">
    <div class="slide__head">
      <div class="brand"><img src="assets/logo.png" alt="Elarah"></div>
      <div class="head-right"><span class="kicker">Pensado pra celebração</span></div>
    </div>
    <span class="eyebrow orange">◆ Como funciona</span>
    <h2>Um encontro <em>cheio de afeto</em></h2>
    <p class="lead">Uma manhã <strong>delicada e sensorial</strong> pra celebrar os 50 anos com as mulheres que ela ama — todo mundo de mãos na massa, entre flores e aromas. Uma comemoração que rende <strong>afeto, fotos lindas e uma lembrança feita à mão</strong>, pra qualquer uma, sem talento nenhum.</p>
    <div class="rule"></div>
    <div class="grid3">
      <div class="infocard"><div class="ico"><svg viewBox="0 0 28 28" fill="none" stroke="#C06C86" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><path d="M14 3.5 L16 12 L24.5 14 L16 16 L14 24.5 L12 16 L3.5 14 L12 12 Z"/></svg></div><h3>Floral & sensorial</h3><p>Flores, cores e aromas — cada uma cria a própria peça à mão e leva pra casa.</p></div>
      <div class="infocard"><div class="ico"><svg viewBox="0 0 28 28" fill="none" stroke="#C06C86" stroke-width="1.6" stroke-linejoin="round"><path d="M14 24s-8.5-5-8.5-11a4.8 4.8 0 0 1 8.5-3 4.8 4.8 0 0 1 8.5 3c0 6-8.5 11-8.5 11z"/></svg></div><h3>Só de vocês</h3><p>Turma 100% privativa, a aniversariante no centro — as mulheres que ela ama, juntas.</p></div>
      <div class="infocard"><div class="ico"><svg viewBox="0 0 28 28" fill="none" stroke="#C06C86" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><path d="M3.5 21V11l10.5-7 10.5 7v10M10 21v-6h8v6"/></svg></div><h3>Num café charmoso</h3><p>Numa cafeteria parceira linda ou onde vocês preferirem — a gente leva tudo.</p></div>
    </div>
    <div class="quote">
      <i>"As melhores memórias a gente cria com as mãos."</i><br>
      — E 50 anos é o dia perfeito pra <strong>celebrar entre flores e afeto</strong>. 🌸
    </div>
    {foot("Pensado pra celebração")}
  </section>'''
...
vibe = f'''
  <section class="slide">
    ...
    <div class="note" style="margin-top:16px">◆ E o melhor: cada uma sai com a <b>própria criação</b> na mão — a lembrança perfeita de um dia inesquecível. 💛</div>
...
menu = f'''
  <section class="slide">
    ...
    <h2>Duas opções <em>florais</em></h2>
    <p class="lead">Duas experiências delicadas e sensoriais pra escolher a que mais combina com a comemoração — em ambas, cada uma cria a sua peça e leva pra casa de recordação. 🌸</p>
    <div class="rule"></div>
    <div class="menu">
      {exp("Opção 1","buqueflor.jpg","Arranjo Floral + Home Spray","Cada uma monta o próprio arranjo de flores e ainda leva um home spray autoral — pra perfumar a casa com o aroma da comemoração. Delicado e cheio de charme.","Buquê de flores do campo montado à mão","center 50%")}
      {exp("Opção 2","pinturavasoearranjo.jpg","Pintura em Vaso + Arranjo Floral","Um combo 2 em 1: cada uma pinta o próprio vaso de vidro e ainda monta o arranjo de flores pra levar pra casa. Uma lembrança dupla e linda.","Vasos de vidro pintados à mão com arranjos de flores","center 45%")}
    </div>
...
espacos = f'''
  <section class="slide">
    ...
    <span class="eyebrow orange">◆ Dois cafés charmosos</span>
    <h2>Onde <em>acontece</em></h2>
    <p class="lead">Escolham entre duas cafeterias parceiras lindas e aconchegantes — o cenário perfeito pra uma manhã entre flores e afeto. E, se preferir, a gente também leva até você.</p>
    <div class="rule"></div>
    <div class="venues">
      <div class="bfeat">
        <div class="bphoto"><img src="assets/julescampobelo.jpg" alt="Cafeteria Jules l'Art du Pain, ambiente charmoso" style="object-position:center 55%"></div>
        <div class="bbody">
          <span class="btag">★ Cafeteria parceira</span>
          <h3>Jules <span class="sub">l'Art du Pain · Campo Belo</span></h3>
          <p>Um cantinho lindo e aconchegante, com aquele charme de padaria francesa. O clima perfeito pra criar e comemorar numa manhã especial.</p>
        </div>
      </div>
      <div class="bfeat plain">
        <div class="bphoto"><img src="assets/sowcafe.jpg" alt="Sow Cake Lounge, café aconchegante com plantas" style="object-position:center 40%"></div>
        <div class="bbody">
          <span class="btag soft">Cafeteria parceira</span>
          <h3>Sow Cake Lounge <span class="sub">Vila Mariana</span></h3>
          <p>Um lounge cheio de verde e personalidade, super acolhedor. Um espaço lindo pra reunir as mulheres em volta das flores.</p>
        </div>
      </div>
    </div>
    <div class="note" style="margin-top:15px">◆ E se preferir, a gente também <b>leva a experiência até você</b> — na sua casa ou onde quiser. 🌸</div>
    {foot("Onde acontece")}
  </section>'''
...
planos = f'''
  <section class="slide">
    ...
    <h2>A partir de <em>R$ 229</em></h2>
    <p class="lead">É só escolher a experiência e o nível. Todos os valores são <strong>por pessoa</strong>, com material e condução inclusos. 🌸</p>
    <div class="rule"></div>
    <table class="itable">
      <thead><tr>
        <th class="corner"></th>
      ...
      <tbody>
        <tr>
          <td class="rl"><b>Arranjo Floral + Home Spray</b><span>Monta o arranjo &amp; leva um home spray autoral</span></td>
          <td class="val">R$ 229</td><td class="val">R$ 329</td><td class="val hl">R$ 429</td>
        </tr>
        <tr>
          <td class="rl"><b>Pintura em Vaso + Arranjo Floral</b><span>✨ Combo 2 em 1 — vaso pintado &amp; arranjo</span></td>
...
como = f'''
  <section class="slide">
    ...
    <h2>É só <em>reunir as mulheres</em></h2>
    <p class="lead">A Elarah cuida de toda a produção pra a manhã ser leve do começo ao fim:</p>
    <div class="rule"></div>
    <div class="steps">
      <div class="step"><div class="num">1</div><h3>Escolhem a experiência</h3><p>Arranjo Floral + Home Spray ou Pintura em Vaso + Arranjo Floral, no nível que preferirem.</p></div>
      <div class="step"><div class="num">2</div><h3>Escolhem o café</h3><p>Jules (Campo Belo) ou Sow Cake Lounge (Vila Mariana) — ou a gente leva até você.</p></div>
      <div class="step"><div class="num">3</div><h3>É só criar e celebrar</h3><p>Todo mundo põe a mão na massa e cada uma leva a própria criação pra casa.</p></div>
    </div>
    <div class="addon">
      <span class="plus">+</span>
      <div>
        <h4>Do jeitinho dela 🌸</h4>
        <p>A gente personaliza a experiência com a cara da comemoração — e ajuda a deixar tudo pronto pra a manhã ficar inesquecível.</p>
      </div>
    </div>
    <div class="cta">
      <h2>Bora celebrar os <em>50 anos?</em> ✦</h2>
      <p>Me conta qual experiência mais chamou, o café e a data (19 ou 26/09), que a gente fecha cada detalhe.</p>
      <div class="cta-actions">
        <a class="btn-wa" href="https://wa.me/5511914455930?text=Oi%2C%20Elarah!%20Vi%20a%20proposta%20de%20anivers%C3%A1rio%20de%2050%20anos%20e%20quero%20saber%20mais." target="_blank" rel="noopener">
          💬 Falar no WhatsApp
        </a>
    ...
    <p class="fineprint">Proposta de experiência de aniversário de 50 anos da Elarah, turma privada de cerca de 15 a 20 mulheres, numa manhã de 19 ou 26 de setembro. Experiência à escolha: Arranjo Floral + Home Spray a partir de R$ 229 por pessoa (níveis R$ 229 / 329 / 429) — ou o combo Pintura em Vaso + Arranjo Floral a partir de R$ 289 por pessoa (níveis R$ 289 / 389 / 489). Níveis: Só a experiência (material & condução inclusos) / Com registro (+ foto profissional e voucher de R$ 50 para consumo na cafeteria) / Completo (+ personalização & lembrancinha), subindo R$ 100 por nível. Realizada na cafeteria parceira Jules (l'Art du Pain · Campo Belo) ou Sow Cake Lounge (Vila Mariana), ou no local do grupo. Valores por pessoa. Proposta válida mediante confirmação de data e disponibilidade de agenda.</p>
    {foot("Experiência · 50 anos · 2026")}
  </section>'''

deck = '<div class="deck">\n' + cover + buscamos + vibe + menu + espacos + planos + personaliza + como + '\n\n</div>\n\n'
# fix title/meta
head = head.replace("<title>Experiência Corporativa · Elarah × Compass</title>", "<title>Aniversário 50 anos · Elarah</title>")
head = re.sub(r'<meta name="description"[^>]*>', '<meta name="description" content="Proposta de experiência da Elarah para aniversário de 50 anos — oficina floral, turma privativa.">', head)
html = head + deck + tail
out = "/home/user/elarahplatform/experiencia-aniversario-50anos.html"
