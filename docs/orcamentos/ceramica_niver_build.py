...
BODY = ('<p>Um aniversário diferente pra reunir as amigas: cada uma modela a sua '
        '<b style="color:#FF5E8A">peça em cerâmica fria, à mão</b>, do seu jeitinho, e leva pra casa '
...
retext(p2, (52, 171, 505, 250),
       "Aqui cada convidada vira ceramista por um dia: molda a própria peça em cerâmica fria, à mão, "
       "do seu jeito, e leva pra casa a sua criação. Uma experiência sensorial, relaxante e "
...
INCL = [
    ("Massa e todos os materiais", "tudo incluso, é só colocar a mão na massa"),
    ("Condução por ceramista", "acompanha e ajuda cada convidada"),
    ("Modelagem em cerâmica fria", "molde a sua peça à mão, do seu jeito"),
    ("A sua peça é sua", "seca naturalmente, é só levar pra casa"),
]
...
_VW = 157.2
for _pth, _x0, _vb in [("desp-hero4.jpg", 51.8, 0.3), ("ceramica-fria.jpg", 218.0, 0.5), ("modelceramicafria.jpg", 384.3, 0.5)]:
...
# dois espaços (fotos)
photo(p3, A_DIR+"ceramicafamiliamais12.jpg", (54, 250, 294, 388), vbias=0.4)
put(p3, "Ateliês de Cerâmica", FSB, 10.5, DARKt, 54, 404)
put(p3, "modelagem em cerâmica fria, à mão", FS, 8.2, MUTED, 54, 417)
...
put_spaced(p3, "✦ INVESTIMENTO · MODELAGEM EM CERÂMICA FRIA", 80, 586, 9, CORAL_RGB, FSB)
...
put(p3, "Inclui a massa, os materiais e a condução. A peça seca naturalmente e vai pra casa. Valor final conforme o espaço.",
...
put(p4, "Como vai ser o encontro", FSER, 14.2, NEARBLK, 149.4, 244.5)
photo(p4, A_DIR+"casalmodelagemceramica.jpg", (52, 257, 294, 481), vbias=0.5)
photo(p4, A_DIR+"modelagemcer.jpg", (302, 257, 542, 481), vbias=0.5)
...
p4.insert_textbox(fitz.Rect(53.8, 655, 538, 690),
    "Valor por pessoa a partir de R$ 199 (modelagem em cerâmica fria), para 5 pessoas. Inclui a "
    "massa, os materiais e a condução. Proposta válida mediante confirmação de data e espaço.",
