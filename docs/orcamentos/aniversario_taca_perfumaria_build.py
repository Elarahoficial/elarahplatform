...
# ---- recolor: lavanda-lilás (aniversário) ----
head = head.replace("--orange:#F27623;", "--orange:#8C6BB1;")
head = head.replace("--orange-dark:#D4600E;", "--orange-dark:#6E4E92;")
head = head.replace("--navy:#16233C;", "--navy:#2C2436;")
head = head.replace("--navy-soft:#3B4E6B;", "--navy-soft:#5E5470;")
head = head.replace("--blue-accent:#4C6EA3;", "--blue-accent:#8C6BB1;")
head = head.replace("#EDF1F7", "#F4F0FA").replace("#DCE5F1", "#E6DDF3")
head = head.replace("#FF9A4D", "#B79AD6")
head = head.replace("rgba(242,118,35,.22)", "rgba(140,107,177,.26)")
...
extra = '''
  ...
  .exp .top{position:absolute;top:11px;left:11px;z-index:3;background:var(--orange);color:#fff;font-size:9px;font-weight:700;letter-spacing:.05em;text-transform:uppercase;padding:5px 11px;border-radius:999px;box-shadow:0 6px 14px -4px rgba(110,78,146,.4)}
    ...
    <div class="cover">
      <div>
        ...
        <div class="chips">
          ...
          <span class="chip"><b>Início de setembro</b></span>
...
como = f'''
  <section class="slide">
    ...
    <div class="steps">
      ...
      <div class="step"><div class="num">2</div><h3>Escolham o espaço</h3><p>Cafeteria parceira (Jules ou Betc Havas) ou o Bake Studio exclusivo só de vocês, no início de setembro.</p></div>
    ...
    <div class="cta">
      ...
      <p>Me confirma a experiência, o espaço e a data (início de setembro), que a gente organiza tudo.</p>
...
head = head.replace("</head>",
    ...
    "</style>\n</head>")
html = head + deck + tail
out = "/home/user/elarahplatform/experiencia-aniversario-set.html"
