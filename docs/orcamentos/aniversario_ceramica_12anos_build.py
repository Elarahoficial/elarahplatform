# Aniversário 12 anos · Cerâmica · 10 amigas · outubro — 2 opções de espaço (Betc Havas + Bake Studio). Lilás palette.
import re
...
# ---- recolor: lilás / lavanda (docinho, 12 anos) ----
head = head.replace("--orange:#F27623;", "--orange:#8E7CC8;")
head = head.replace("--orange-dark:#D4600E;", "--orange-dark:#6A55A8;")
head = head.replace("--navy:#16233C;", "--navy:#2B2440;")
head = head.replace("--navy-soft:#3B4E6B;", "--navy-soft:#64607A;")
head = head.replace("--blue-accent:#4C6EA3;", "--blue-accent:#8E7CC8;")
head = head.replace("#EDF1F7", "#F2EFF9").replace("#DCE5F1", "#E3DBF1")
head = head.replace("#FF9A4D", "#A996D8")
head = head.replace("rgba(242,118,35,.22)", "rgba(142,124,200,.28)")
...
extra = '''
  ...
  .exp .top{position:absolute;top:11px;left:11px;z-index:3;background:var(--orange);color:#fff;font-size:9px;font-weight:700;letter-spacing:.05em;text-transform:uppercase;padding:5px 11px;border-radius:999px;box-shadow:0 6px 14px -4px rgba(106,85,168,.4)}
  ...
  <section class="slide">
    <div class="slide__head">
      ...
      <div class="head-right">
        ...
        <span class="compass">12 <span>anos</span><small>Cerâmica &amp; amigas</small></span>
      </div>
    </div>
    <div class="cover">
      <div>
        <span class="eyebrow">✦ Aniversário de 12 anos · Cerâmica</span>
        <h1>12 anos<br>de <em>arte</em></h1>
        <p class="lead">Um aniversário diferente e cheio de charme pra ela e as amigas: um <strong>workshop de cerâmica</strong> onde cada uma cria a própria peça à mão e leva pra casa de recordação. Diversão e criatividade do começo ao fim. 🎨</p>
        <div class="rule"></div>
        <div class="chips">
          <span class="chip"><b>12</b> anos</span>
          <span class="chip"><b>10</b> amigas</span>
          <span class="chip"><b>Outubro</b> · a combinar</span>
        </div>
      </div>
      <div class="cover-photo">
        <img src="assets/aniv-infantil.jpg" alt="Meninas criando e pintando cerâmica juntas numa experiência da Elarah" style="object-position:center 25%">
      </div>
    </div>
    ...
    {foot("Aniversário de 12 anos · Cerâmica")}
  </section>'''
...
experiencia = f'''
  <section class="slide">
    ...
    <span class="eyebrow orange">◆ O workshop de cerâmica</span>
    <h2>Criar com as <em>próprias mãos</em></h2>
    <p class="lead">Uma experiência mão na massa, super divertida e sensorial: cada menina <strong>modela a argila</strong>, <strong>pinta e decora</strong> a própria peça — do jeitinho dela. No fim, todas levam a criação pra casa como lembrança do dia. 🎨</p>
    <div class="rule"></div>
    <div class="menu">
      {exp("01","ceramicamodelagem.jpg","Modelar à mão","Sentir a argila e dar forma à própria peça — um momento leve, relaxante e cheio de descobertas.","Mãos modelando uma peça de cerâmica","center 50%")}
      {exp("02","ceramicacool.jpg","Pintar &amp; decorar","Cores, padrões e muita personalidade — cada peça fica única, com a cara de quem criou.","Peças de cerâmica pintadas à mão com padrões coloridos","center 50%")}
    </div>
    <div class="note" style="margin-top:14px">◆ Sem precisar de experiência nenhuma — a gente leva profissional, material e toda a estrutura. É só chegar e criar. 🎨</div>
    {foot("A experiência")}
  </section>'''
...
espacos = f'''
  <section class="slide">
    ...
    <p class="lead">Dois espaços parceiros lindos, cada um com seu clima — a cafeteria charmosa ou o estúdio só de vocês. É só escolher qual combina mais com a festa da aniversariante. 🎉</p>
    <div class="rule"></div>
    ...
    <div class="bfeat" style="margin-top:15px;height:210px">
      ...
      <div class="bbody">
        ...
        <p>Um estúdio charmoso com cozinha e sala, <b>só de vocês</b> — com liberdade pra decorar do jeito que quiserem. Espaço exclusivo e reservado, do começo ao fim. 🌿</p>
      </div>
    </div>
    {foot("Onde acontece")}
  </section>'''
...
planos = f'''
  <section class="slide">
    ...
    <p class="lead">Escolha o espaço e o nível que mais combinam. Valores por pessoa, com material e condução inclusos — e cada menina sempre leva a própria peça de cerâmica. 🎨</p>
    <div class="rule"></div>
    ...
    <table class="itable">
      ...
      <tbody><tr>
        <td class="rl"><b>Cerâmica</b><span>Cada menina cria e leva a própria peça</span></td>
        <td class="val">R$ 199</td><td class="val">R$ 299</td><td class="val hl">R$ 399</td>
      </tr></tbody>
    </table>

    <div class="vtitle">Opção 2 · Bake Studio · Bela Vista <span>espaço exclusivo · podem decorar</span></div>
    <table class="itable">
      <thead><tr>
        <th class="corner"></th>
      ...
      <tbody><tr>
        <td class="rl"><b>Cerâmica</b><span>Espaço só de vocês, com liberdade pra decorar</span></td>
        <td class="val">R$ 279</td><td class="val hl">R$ 499</td>
      </tr></tbody>
    </table>

    <div class="note" style="margin-top:15px">◆ Valores <b>por pessoa</b>, com material e condução inclusos. No <b>Betc Havas Café</b> a comida é à parte; o nível Com foto soma a foto profissional e R$ 30 de voucher de consumo, e o Completo soma a lembrancinha. No <b>Bake Studio</b> o espaço é exclusivo e reservado, e o Completo já inclui foto profissional &amp; lembrancinha.</div>
    {foot("Investimento")}
  </section>'''
...
personaliza = f'''
  <section class="slide">
    ...
    <p class="lead">Dois extras opcionais que deixam a festa ainda mais marcante — o registro profissional e a lembrancinha personalizada pra cada convidada.</p>
    <div class="rule"></div>
    <div class="plans">
      <div class="plan">
...
como = f'''
  <section class="slide">
    ...
    <div class="rule"></div>
    <div class="steps">
      <div class="step"><div class="num">1</div><h3>Escolham o espaço</h3><p>Betc Havas Café ou o Bake Studio exclusivo — a gente reserva e organiza tudo pra vocês.</p></div>
      <div class="step"><div class="num">2</div><h3>A gente leva tudo</h3><p>Profissional, argila, tintas e toda a estrutura da cerâmica. As meninas só chegam e criam.</p></div>
      <div class="step"><div class="num">3</div><h3>Cada uma leva a arte</h3><p>No fim, todas levam pra casa a própria peça — uma lembrança linda dos 12 anos. 🎨</p></div>
    </div>
    <div class="addon">
      <span class="plus">+</span>
      <div>
        <h4>Sob medida pra ela</h4>
        <p>A gente ajusta cada detalhe conforme o número de convidadas, o espaço e o clima que vocês querem pra festa. É só combinar. 🎉</p>
      </div>
    </div>
    <div class="cta">
      <h2>Bora comemorar <em>criando?</em> ✦</h2>
      <p>Me confirma o espaço que vocês preferem e a data de outubro, que a gente fecha tudo pra festa da aniversariante.</p>
      <div class="cta-actions">
        <a class="btn-wa" href="https://wa.me/5511914455930?text=Oi%2C%20Elarah!%20Vi%20a%20proposta%20do%20anivers%C3%A1rio%20de%20cer%C3%A2mica%20e%20quero%20fechar%20os%20detalhes." target="_blank" rel="noopener">
          💬 Falar no WhatsApp
        </a>
    ...
    <p class="fineprint">Proposta de aniversário da Elarah — workshop de cerâmica para o aniversário de 12 anos, para cerca de 10 convidadas, em outubro (data a combinar). Cada convidada cria e leva a própria peça. Opção 1 · Betc Havas Café (comida à parte): a partir de R$ 199 por pessoa (níveis R$ 199 / 299 / 399) — A experiência (material e condução) / + foto profissional e R$ 30 de voucher de consumo / Completo com lembrancinha. Opção 2 · Bake Studio (Bela Vista), espaço exclusivo com liberdade pra decorar: a partir de R$ 279 por pessoa; Completo por R$ 499 com foto profissional e lembrancinha. Valores por pessoa. Proposta válida mediante confirmação de data e disponibilidade de agenda.</p>
    {foot("Aniversário de 12 anos · Cerâmica · 2026")}
  </section>'''

deck = '<div class="deck">\n' + cover + experiencia + espacos + planos + personaliza + como + '\n\n</div>\n\n'
head = head.replace("<title>Setembro Amarelo · Elarah</title>", "<title>Aniversário 12 anos · Cerâmica · Elarah</title>")
head = re.sub(r'<meta name="description" content="[^"]*">', '<meta name="description" content="Proposta de aniversário de 12 anos da Elarah — workshop de cerâmica no Betc Havas Café ou Bake Studio.">', head)
head = head.replace("</head>",
    ...
    "</style>\n</head>")
html = head + deck + tail
out = "/home/user/elarahplatform/experiencia-aniversario-ceramica-12.html"
