  ...
  <section class="slide">
    ...
    <div class="cover">
      ...
      <div class="cover-photo">
        <img src="assets/aniv-adulto.jpg" alt="Amigas felizes numa mesa decorada comemorando" style="object-position:center 40%">
      </div>
    </div>
...
planos = f'''
  <section class="slide">
    ...
    <div class="note" style="margin-top:18px">◆ Valor <b>por pessoa</b>, com material e condução inclusos. O nível <b>Com foto &amp; coffee</b> soma a foto profissional do evento e um coffee break; o <b>Completo</b> soma também a lembrancinha personalizada. A gente leva tudo até o espaço de vocês, no Ipiranga. Data a combinar.</div>
    {foot("Investimento")}
  </section>'''
