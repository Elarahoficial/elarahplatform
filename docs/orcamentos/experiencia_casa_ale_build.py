...
# ---- recolor CSS to botanical sage green + dusty rose (cerâmica & arranjos florais) ----
head = head.replace("--orange:#F27623;", "--orange:#C47A86;")       # accent: dusty rose
head = head.replace("--orange-dark:#D4600E;", "--orange-dark:#A05563;")
head = head.replace("--navy:#16233C;", "--navy:#3A4536;")           # deep sage/olive green (headings/dark)
head = head.replace("--navy-soft:#3B4E6B;", "--navy-soft:#66705E;") # muted sage for lead
head = head.replace("--blue-accent:#4C6EA3;", "--blue-accent:#C47A86;")
head = head.replace("#EDF1F7", "#F4EEEF").replace("#DCE5F1", "#E7DBDD")
head = head.replace("#FF9A4D", "#D89AA2")
head = head.replace("rgba(242,118,35,.22)", "rgba(196,122,134,.26)")
head = head.replace(".itable .hl{background:#F7EAEF}", ".itable .hl{background:#EFE6E8}")  # soft blush highlight
head = head.replace(".tier.hl{border:2px solid var(--navy);background:#FBEBDF}", ".tier.hl{border:2px solid var(--navy);background:#EFE6E8}")
  ...
  <section class="slide">
    <div class="slide__head">
      ...
      <div class="head-right">
        <span class="kicker">Proposta de experiência em casa</span>
        <span class="compass">Experiência <span>em casa</span><small>Alphaville · 16 ou 17 de setembro</small></span>
      </div>
    </div>
    <div class="cover">
      <div>
        <span class="eyebrow">✦ Experiência · Na sua casa</span>
        <h1>A experiência <br><em>na sua casa</em></h1>
        <p class="lead">Uma tarde <strong>criativa e aconchegante</strong>, sem sair de casa — uma oficina de <strong>Cerâmica</strong> ou <strong>Arranjos Florais</strong>. A gente leva tudo até você e cada um cria (e leva pra casa) a própria peça. 🌸</p>
        <div class="rule"></div>
        <div class="chips">
          <span class="chip"><b>10</b> convidados</span>
          <span class="chip"><b>16 ou 17</b> de setembro</span>
          <span class="chip">Em <b>Alphaville</b></span>
        </div>
      </div>
      <div class="cover-photo">
        <img src="assets/buque.jpg" alt="Mãos segurando um arranjo de flores delicado" style="object-position:center 45%">
      </div>
    </div>
    {foot("Experiência · Na sua casa")}
  </section>'''
...
buscamos = f'''
  <section class="slide">
    <div class="slide__head">
      <div class="brand"><img src="assets/logo.png" alt="Elarah"></div>
      <div class="head-right"><span class="kicker">Como funciona em casa</span></div>
    </div>
    <span class="eyebrow orange">◆ Como funciona</span>
    <h2>A gente <em>leva tudo</em></h2>
    <p class="lead">A experiência em casa é super <strong>aconchegante e sem preocupação</strong>: vai o profissional pra conduzir, todo o material e a estrutura da oficina. Vocês só preparam o espacinho e curtem — e cada um leva pra casa o que criou. 🌸</p>
    <div class="rule"></div>
    <div class="grid3">
      <div class="infocard"><div class="ico"><svg viewBox="0 0 28 28" fill="none" stroke="#C47A86" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><path d="M14 3.5 L16 12 L24.5 14 L16 16 L14 24.5 L12 16 L3.5 14 L12 12 Z"/></svg></div><h3>Criativo & sensorial</h3><p>Cerâmica ou arranjos florais — cada um cria a sua peça à mão e leva a criação pra casa.</p></div>
      <div class="infocard"><div class="ico"><svg viewBox="0 0 28 28" fill="none" stroke="#C47A86" stroke-width="1.6" stroke-linejoin="round"><path d="M14 24s-8.5-5-8.5-11a4.8 4.8 0 0 1 8.5-3 4.8 4.8 0 0 1 8.5 3c0 6-8.5 11-8.5 11z"/></svg></div><h3>Só de vocês</h3><p>Turma 100% privativa, na sua casa — todo mundo junto, no maior aconchego.</p></div>
      <div class="infocard"><div class="ico"><svg viewBox="0 0 28 28" fill="none" stroke="#C47A86" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><path d="M3.5 21V11l10.5-7 10.5 7v10M10 21v-6h8v6"/></svg></div><h3>A gente leva até você</h3><p>Profissional, material e estrutura por nossa conta. Vocês só preparam o espacinho e curtem.</p></div>
    </div>
    <div class="quote">
      <i>"As melhores memórias a gente cria com as mãos."</i><br>
      — E não tem lugar mais especial pra isso do que a <strong>sua casa</strong>. 🏡
    </div>
    {foot("Como funciona em casa")}
  </section>'''
...
vibe = f'''
  <section class="slide">
    ...
    <p class="lead">Um cantinho aconchegante em casa, todo mundo criando junto, sem pressa — leve, sensorial e cheio de conexão. É esse o clima de uma experiência Elarah: uma tarde que vira memória afetiva. 🌸</p>
    <div class="rule"></div>
    <div class="pgrid g3">
      <div class="pcard"><div class="sq"><img src="assets/desp-hero4.jpg" alt="Mesa posta e montada com carinho para a experiência" style="object-position:center 30%"></div><div class="pb"><span class="n">A vibe</span><h3>Mesa posta</h3><p>Tudo montado com carinho — do material à ambientação, pronto pra criar.</p></div></div>
      ...
      <div class="pcard"><div class="sq"><img src="assets/aniv-adulto.jpg" alt="Amigas celebrando juntas em casa" style="object-position:center 40%"></div><div class="pb"><span class="n">A vibe</span><h3>Memória afetiva</h3><p>Uma tarde diferente, que todo mundo lembra depois.</p></div></div>
    </div>
...
menu = f'''
  <section class="slide">
    ...
    <h2>Cerâmica <em>ou</em> Arranjos Florais</h2>
    <p class="lead">Duas experiências sensoriais e cheias de charme pra escolher a que mais tem a sua cara — em ambas, cada um cria a sua peça e leva pra casa de recordação.</p>
    <div class="rule"></div>
    <div class="menu">
...
como = f'''
  <section class="slide">
    ...
    <p class="lead">A Elarah cuida de toda a produção pra a experiência em casa ser leve do começo ao fim:</p>
    <div class="rule"></div>
    <div class="steps">
      <div class="step"><div class="num">1</div><h3>Escolhem a experiência</h3><p>Cerâmica ou Arranjos Florais — no nível que preferirem.</p></div>
      <div class="step"><div class="num">2</div><h3>A gente leva até a sua casa</h3><p>Profissional, material e estrutura por nossa conta. Vocês só preparam o espacinho.</p></div>
      <div class="step"><div class="num">3</div><h3>É só criar e curtir</h3><p>Todo mundo põe a mão na massa e cada um leva a própria criação pra casa.</p></div>
    </div>
    <div class="addon">
      <span class="plus">+</span>
      <div>
        <h4>Do seu jeitinho 🌸</h4>
        <p>A gente personaliza a experiência com a cara da ocasião — e ajuda a deixar tudo pronto pra a sua tarde ficar inesquecível.</p>
      </div>
    </div>
    <div class="cta">
      <h2>Bora viver essa <em>experiência em casa?</em> ✦</h2>
      <p>Me conta qual experiência mais chamou e a data (16 ou 17/09), que a gente fecha cada detalhe.</p>
      <div class="cta-actions">
        <a class="btn-wa" href="https://wa.me/5511914455930?text=Oi%2C%20Elarah!%20Vi%20a%20proposta%20de%20experi%C3%AAncia%20em%20casa%20e%20quero%20saber%20mais." target="_blank" rel="noopener">
          💬 Falar no WhatsApp
        </a>
...
deck = '<div class="deck">\n' + cover + buscamos + vibe + menu + planos + personaliza + como + '\n\n</div>\n\n'
# fix title/meta
head = head.replace("<title>Experiência Corporativa · Elarah × Compass</title>", "<title>Experiência em Casa · Elarah</title>")
head = re.sub(r'<meta name="description"[^>]*>', '<meta name="description" content="Proposta de experiência em casa da Elarah — oficina de Cerâmica ou Arranjos Florais, turma privativa.">', head)
html = head + deck + tail
out = "/home/user/elarahplatform/experiencia-em-casa-ale.html"
