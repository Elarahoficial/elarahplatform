...
vibe = f'''
  <section class="slide">
    ...
    <div class="rule"></div>
    <div class="pgrid g3">
      <div class="pcard"><div class="sq"><img src="assets/ceramica.jpg" alt="Amigas criando juntas numa oficina, mão na massa" style="object-position:center 30%"></div><div class="pb"><span class="n">A vibe</span><h3>Mão na massa</h3><p>Todo mundo criando junto, sem pressa e sem talento nenhum.</p></div></div>
