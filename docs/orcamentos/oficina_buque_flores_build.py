...
# ---- recolor: verde-jardim (buquê) ----
head = head.replace("--orange:#F27623;", "--orange:#5E8B6E;")
head = head.replace("--orange-dark:#D4600E;", "--orange-dark:#456B52;")
head = head.replace("--navy:#16233C;", "--navy:#26332A;")
head = head.replace("--navy-soft:#3B4E6B;", "--navy-soft:#556A5C;")
head = head.replace("--blue-accent:#4C6EA3;", "--blue-accent:#5E8B6E;")
head = head.replace("#EDF1F7", "#EFF4EF").replace("#DCE5F1", "#DCEBE0")
head = head.replace("#FF9A4D", "#93B79E")
head = head.replace("rgba(242,118,35,.22)", "rgba(94,139,110,.26)")
...
extra = '''
  ...
  .exp .top{position:absolute;top:11px;left:11px;z-index:3;background:var(--orange);color:#fff;font-size:9px;font-weight:700;letter-spacing:.05em;text-transform:uppercase;padding:5px 11px;border-radius:999px;box-shadow:0 6px 14px -4px rgba(69,107,82,.4)}
  ...
  <section class="slide">
    <div class="slide__head">
      ...
      <div class="head-right">
        ...
        <span class="compass">Oficina <span>Elarah</span><small>Buquê de flores</small></span>
      </div>
    </div>
    <div class="cover">
      <div>
        <span class="eyebrow">✦ Oficina · Buquê de flores</span>
        <h1>Um buquê<br>feito à <em>mão</em></h1>
        <p class="lead">Uma manhã criativa e cheia de charme pra turma: uma <strong>oficina de buquê de flores</strong>, onde cada uma monta o próprio arranjo com flores da estação e leva pra casa. Puro clima de encontro, delicadeza e boas conversas. 🌷</p>
        <div class="rule"></div>
        <div class="chips">
          <span class="chip"><b>30/08</b> · 10h30</span>
          <span class="chip">Turma <b>privada</b></span>
          <span class="chip"><b>3 opções</b> de espaço</span>
        </div>
      </div>
      <div class="cover-photo">
        <img src="assets/buque.jpg" alt="Buquê de flores delicado montado à mão" style="object-position:center 45%">
      </div>
    </div>
    ...
    {foot("Oficina de buquê de flores")}
  </section>'''
...
experiencias = f'''
  <section class="slide">
    ...
    <span class="eyebrow orange">◆ Oficina de buquê de flores</span>
    <h2>Cada buquê, <em>uma arte</em></h2>
    <p class="lead">Com flores fresquinhas da estação, cada convidada monta o próprio buquê — escolhe as cores, as texturas e o jeitinho dela. A gente leva o profissional, as flores e toda a estrutura; vocês só chegam e criam. 🌷🌿</p>
    <div class="rule"></div>
    <div class="menu">
      {exp("01","buqueflor.jpg","Cada buquê, único","Flores do campo, cores e texturas — cada uma monta o próprio arranjo, do jeitinho dela.","Buquê de flores silvestres colorido montado à mão","center 45%")}
      {exp("02","buque.jpg","Do seu jeito","Da paleta delicada à mais vibrante, cada buquê fica com a cara de quem montou.","Buquê de flores em tons de rosa montado à mão","center 45%")}
    </div>
    <div class="note" style="margin-top:14px">◆ Estas são <b>inspirações</b> — na hora, cada convidada monta o próprio buquê, livre e do jeitinho dela, e leva pra casa. 🌷</div>
    {foot("A oficina")}
  </section>'''
...
como = f'''
  <section class="slide">
    ...
    <div class="rule"></div>
    <div class="steps">
      <div class="step"><div class="num">1</div><h3>Escolham o espaço</h3><p>Jules · Campo Belo, Betc Havas Café ou no seu próprio espaço — a gente reserva pro dia 30/08 às 10h30.</p></div>
      <div class="step"><div class="num">2</div><h3>A gente leva tudo</h3><p>Profissional, flores da estação e toda a estrutura da oficina. Vocês só chegam e montam.</p></div>
      <div class="step"><div class="num">3</div><h3>Cada uma leva o buquê</h3><p>No fim, todo mundo leva pra casa o próprio buquê — uma lembrança linda do dia. 🌷</p></div>
    </div>
    <div class="addon">
    ...
    <div class="cta">
      <h2>Bora <em>montar buquês?</em> ✦</h2>
      <p>Me confirma o espaço e o número de convidadas, que a gente organiza tudo pro dia 30/08 às 10h30.</p>
      <div class="cta-actions">
        <a class="btn-wa" href="https://wa.me/5511914455930?text=Oi%2C%20Elarah!%20Vi%20a%20proposta%20da%20oficina%20de%20buqu%C3%AA%20de%20flores%20e%20quero%20fechar%20os%20detalhes." target="_blank" rel="noopener">
          💬 Falar no WhatsApp
        </a>
    ...
    <p class="fineprint">Proposta da Elarah — oficina de buquê de flores, para turma privada, no dia 30/08 às 10h30 (a combinar). Cada convidada monta e leva o próprio buquê. Valores por pessoa, com material e condução inclusos. No Jules · Campo Belo: R$ 199 por pessoa. No Betc Havas Café: R$ 249 por pessoa, já com R$ 50 de voucher de consumo para usar no café. No seu próprio espaço (a Elarah leva tudo até você): R$ 199 por pessoa. Proposta válida mediante confirmação de data e disponibilidade de agenda.</p>
    {foot("Oficina de buquê de flores · 2026")}
  </section>'''

deck = '<div class="deck">\n' + cover + experiencias + vibe + espacos + como + '\n\n</div>\n\n'
head = head.replace("<title>Setembro Amarelo · Elarah</title>", "<title>Oficina de Buquê de Flores · Elarah</title>")
head = re.sub(r'<meta name="description" content="[^"]*">', '<meta name="description" content="Proposta da Elarah — oficina de buquê de flores, no Jules, no Betc Havas Café ou no seu espaço.">', head)
head = head.replace("</head>",
    ...
    "</style>\n</head>")
html = head + deck + tail
out = "/home/user/elarahplatform/experiencia-buque-flores.html"
