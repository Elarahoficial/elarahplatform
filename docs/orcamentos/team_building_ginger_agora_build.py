...
# v3: layout da 1a versao + ajustes. Preco R$269/pessoa (chip simples), sem emojis slide2, fotos ceramica HQ, venda emocional, menu completo sem foto.
...
xcss = '''
  .checks{display:grid;grid-template-columns:1fr 1fr;gap:12px 26px;margin-top:18px}
  .checks li{list-style:none;position:relative;padding-left:28px;font-size:13.5px;color:var(--ink);line-height:1.35}
...
{head_simple("Por que funciona")}
    ...
    <h2>Um encontro que o time <em>lembra depois</em></h2>
    <p class="lead">A conexão acontece sozinha quando o time senta na mesma mesa pra criar com as próprias mãos — sem hierarquia, sem quem sabe mais e quem sabe menos. São 3 horas que soltam o grupo de verdade e viram assunto por semanas.</p>
    <div class="rule"></div>
    <div class="grid3">
      <div class="infocard"><div class="num">01</div><h3>Conversa que não rola no escritório</h3><p>Horas lado a lado fazem o time falar do que a reunião nunca puxa. Áreas diferentes se aproximam sozinhas.</p></div>
      <div class="infocard"><div class="num">02</div><h3>Todo mundo no mesmo pé</h3><p>Ninguém precisa saber modelar. Diretoria e time começam do zero juntos — e é aí que a hierarquia cai.</p></div>
      <div class="infocard"><div class="num">03</div><h3>Fica depois do dia</h3><p>Cada um leva a própria peça pra mesa de trabalho. A lembrança do encontro segue visível no dia a dia.</p></div>
    </div>
...
{head_simple("A experiência")}
    ...
    <p class="lead">Modelagem à mão, à mesa posta, com a <strong>ceramista conduzindo</strong> do começo ao fim. A argila desacelera o time, aproxima as conversas — e no fim cada um leva pra casa algo que fez com as próprias mãos, esmaltado e queimado, pronto pra durar.</p>
    <div class="bfeat">
      ...
      <div class="bbody">
        ...
        <ul class="feat">
          <li><span class="st">1</span><b>Boas-vindas</b> — a mesa posta, a playlist e o clima acolhedor do espaço.</li>
...
{head_simple("O que inclui")}
    ...
    <h2>A Ginger só precisa <em>reunir o time</em></h2>
    <p class="lead">Do espaço à última peça queimada, a gente cuida de cada detalhe pro encontro ser leve do começo ao fim.</p>
    <div class="rule"></div>
    <ul class="checks">
...
{head_simple("A atmosfera")}
    ...
    <div class="gstrip">
      <figure>{img("ceramicacool.jpg", "Peças de cerâmica autorais", "center 50%")}<figcaption>As peças que ficam</figcaption></figure>
    ...
    <div class="invbox">
      <div class="incl" style="flex:1;min-width:300px">
        ...
        <ul>
          ...
          <li><span>✦</span>Cada um leva a própria peça pra casa</li>
        </ul>
      </div>
      <div class="pricebox">
        <span class="pl">Cerâmica · 3h · por pessoa</span>
        <span class="pv">R$ 269</span>
        <span class="ps">turma de 14 · total R$ 3.766</span>
      </div>
    </div>
    <div class="bnote">◆ <b>Opção de alimentação</b> — Menu Completo por <b>R$ 150 por pessoa</b>: finger food + doce da casa + café, assinado pela chef parceira do Agora, servido durante a experiência. Com o Menu Completo, o valor por pessoa fica em R$ 419.</div>
    <p class="fineprint">Valor por pessoa para a experiência de cerâmica (modelagem à mão, 3h), turma privada de 14, no Agora Intu (Pinheiros). Datas disponíveis: 23/10 (sex), 29/10 (qui) ou 30/10 (sex). Reserva com sinal de 50%; saldo até 3 dias antes; número de convidados confirmado até 7 dias antes. A Elarah emite nota fiscal.</p>
    {foot("Investimento")}
  </section>'''
