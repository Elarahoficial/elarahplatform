...
planos = f'''
  <section class="slide">
    ...
    <p class="lead">Valores por pessoa, com material e condução inclusos — uma tabela pra cada experiência. É só escolher o espaço e o nível que mais combinam com o encontro. 🌿</p>
    <div class="rule"></div>
    <div class="itbl-label">Pintura em cerâmica <b>◆ tabela 1</b></div>
    <table class="itable cx">
      <thead><tr>
        <th class="corner"></th>
        <th>Basic<span>a experiência</span></th>
        <th>Plus<span>+ foto do evento</span></th>
        <th class="hl">Premium<span>com tudo incluso</span></th>
      </tr></thead>
      <tbody>
        <tr>
        ...
        <tr>
          <td class="rl"><b>Bake Studio</b><span>espaço exclusivo · só do grupo</span></td>
    ...
    <div class="itbl-label">Folding book <b>◆ tabela 2</b></div>
    <table class="itable cx">
      <thead><tr>
        <th class="corner"></th>
        <th>Basic<span>a experiência</span></th>
      ...
      <tbody>
        ...
        <tr>
          <td class="rl"><b>Bake Studio</b><span>espaço exclusivo · só do grupo</span></td>
          <td class="val">R$ 339</td>
          <td class="val">R$ 439<small>+ foto &amp; coffee break</small></td>
          <td class="val hl">R$ 589<small>+ decoração &amp; lembrancinha</small></td>
        </tr>
      </tbody>
    </table>
    <div class="note" style="margin-top:12px">◆ Valores <b>por pessoa</b>, com material e condução inclusos. No <b>Betc Havas</b> já entra R$ 50 de voucher de consumo; o <b>Bake Studio</b> é só do grupo, com coffee break e decoração nos níveis completos. Dia 26/09, a combinar. 🌿</div>
    {foot("Investimento")}
  </section>'''
