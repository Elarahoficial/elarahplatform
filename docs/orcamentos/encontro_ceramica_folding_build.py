...
espacos = f'''
  <section class="slide">
    ...
    <p class="lead">Duas cafeterias parceiras charmosas (ou o Café Faria Lima, também externo) ou o Bake Studio, um estúdio exclusivo só do grupo. É só escolher qual combina mais com o encontro. 🌿</p>
    <div class="rule"></div>
    <div class="vg">
      <div class="vgc">
        ...
        <div class="b"><span class="t">A partir de R$ 199</span><h3>Jules <span class="sub">Campo Belo · ou Café Faria Lima</span></h3><p>Cafeteria charmosa e arejada. Mesmo valor no <b>Café Faria Lima</b> (externo).</p></div>
      </div>
      <div class="vgc">
    ...
    <div class="note" style="margin-top:14px">◆ Cada espaço com o seu valor por pessoa. O <b>Jules · Campo Belo</b> e o <b>Café Faria Lima</b> (externo) têm o mesmo valor; no <b>Betc Havas</b> já entra R$ 50 de voucher de consumo; o <b>Bake Studio</b> é reservado só pro grupo, com coffee break e decoração nos níveis completos. 🌿</div>
    {foot("Onde acontece")}
  </section>'''
  ...
  <section class="slide">
    ...
    <table class="itable">
      ...
      <tbody>
        ...
        <tr>
          <td class="rl"><b>Café Faria Lima</b><span>opção externa · mesmo valor</span></td>
          <td class="val">R$ 199</td>
          <td class="val">R$ 299<small>+ foto profissional</small></td>
          <td class="val hl">R$ 399<small>+ lembrancinha</small></td>
        </tr>
...
como = f'''
  <section class="slide">
    ...
    <div class="steps">
      ...
      <div class="step"><div class="num">2</div><h3>Escolham o espaço</h3><p>Jules · Campo Belo, Café Faria Lima, Betc Havas ou o Bake Studio exclusivo — no dia 26/09.</p></div>
...
head = re.sub(r'<meta name="description" content="[^"]*">', '<meta name="description" content="Proposta da Elarah — encontro de pintura em cerâmica e folding book, no café (Jules/Faria Lima/Betc) ou no Bake Studio.">', head)
