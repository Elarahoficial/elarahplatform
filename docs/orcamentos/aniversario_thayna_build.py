...
planos = f'''
  <section class="slide">
    ...
    <table class="itable">
      ...
      <tbody>
        <tr>
          <td class="rl"><b>Cerâmica ou Vela Aromática</b><span>As duas pelo mesmo valor — cada um leva a sua peça</span></td>
        ...
        <tr>
          ...
          <td class="val">R$ 389</td><td class="val">R$ 489</td><td class="val hl">R$ 589</td>
        </tr>
      </tbody>
    </table>
    ...
    <div class="note" style="margin-top:9px">◆ E ainda dá pra fazer <b>Pintura</b> também (a partir de R$ 199) — é só me chamar! 💛</div>
    {foot("Investimento")}
  </section>'''
