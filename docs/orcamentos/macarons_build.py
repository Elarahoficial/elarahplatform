...
vibe = f'''
  <section class="slide">
    ...
    <div class="vibe">
      <figure><img src="assets/macaron-risada.jpg" alt="Amigas rindo cozinhando juntas" style="object-position:center 30%"><figcaption>Risada garantida</figcaption></figure>
...
espacos = f'''
  <section class="slide">
    ...
    <div class="vgrid">
      <div class="vcard">
        <div class="vph"><img src="assets/receitaria.jpg" alt="Espaço da Escola Receitaria Gourmet"><div class="vpr"><b>R$ 425</b><small>por pessoa</small></div></div>
        <div class="vb">
      ...
      <div class="vcard hl">
        <div class="vph"><img src="assets/espaço2.jpg" alt="Cozinha do Bake Studio"><div class="vpr"><b>R$ 699</b><small>por pessoa</small></div></div>
        <div class="vb">
