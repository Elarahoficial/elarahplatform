...
planos = f'''
  <section class="slide">
    ...
    <div class="note" style="margin-top:18px">◆ <b>Vela ou Cerâmica pelo mesmo valor</b> — é só escolher a preferida. Turma privada de 13, sábado 12/09 à tarde (2h30–3h). Podem levar bolo, doces e espumante. 🥂</div>
    {foot("Investimento")}
  </section>'''
