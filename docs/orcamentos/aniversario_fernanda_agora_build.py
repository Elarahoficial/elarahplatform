...
xcss = '''
  ...
  /* investimento padrao Elarah · valor da experiencia */
  ...
  .pheroph{border-radius:18px;overflow:hidden;border:1px solid var(--line);box-shadow:0 18px 42px -26px rgba(0,0,0,.42);height:430px}
  ...
  .pval .pbig{font-family:'DM Serif Display',serif;font-size:70px;color:var(--navy);line-height:.92;margin:8px 0 2px}
  .pval .pper{font-size:11px;letter-spacing:.16em;text-transform:uppercase;color:var(--navy-soft);font-weight:700}
  .pval .pgrp{font-family:'DM Serif Display',serif;font-size:24px;color:var(--orange-dark);margin:16px 0 0;line-height:1.1}
  ...
  .pval .pnote{font-size:12px;color:var(--muted);margin-top:14px;line-height:1.55;max-width:44ch}
...
# ============================ 4 · INVESTIMENTO (só a experiência) ============================
investimento = f'''
  <section class="slide">
{head_simple("Investimento")}
    <span class="eyebrow orange">◆ Investimento · só a experiência</span>
    <h2>A experiência de <em>cerâmica</em></h2>
    <div class="phero">
      <div class="pheroph">{img("agora-mesa.jpg", "Mesa de cerâmica montada no Agora", "center 50%")}</div>
      <div class="pval">
        <span class="pct">Cerâmica no Agora · Pinheiros</span>
        <div class="pbig">R$ 494</div>
        <span class="pper">por pessoa</span>
        <div class="pgrp">R$ 2.470<small>o grupo de 5 amigas · só a experiência</small></div>
        <p class="pnote">Inclui espaço exclusivo, ceramista conduzindo, todos os materiais, queima, ambientação e café, chá e água. <b>Sem alimentação</b> — os menus abaixo são opcionais, à parte.</p>
      </div>
    </div>
    <p class="subh">Opcionais de alimentação · à parte, por pessoa</p>
    <p class="addons"><b>Tábua de boas-vindas</b> R$ 91 &nbsp;·&nbsp; <b>Finger food</b> R$ 143 &nbsp;·&nbsp; <b>Menu completo</b> R$ 195 &nbsp;·&nbsp; <b>Welcome drink</b> R$ 52 &nbsp;·&nbsp; <b>Serviço de bebidas</b> R$ 32,50</p>
    <p class="fineprint">Valor da experiência de cerâmica, turma privada de 5, no Agora (Pinheiros): <b>R$ 494 por pessoa · R$ 2.470 para o grupo</b> — inclui espaço exclusivo, ceramista, materiais, queima, ambientação e café, chá e água, <b>sem alimentação</b>. Opcionais de alimentação, à parte, por pessoa: tábua R$ 91 · finger food R$ 143 · menu completo R$ 195 · welcome drink R$ 52 · serviço de bebidas R$ 32,50. Aniversário em 26/09, a partir das 17:30. Data e horário sujeitos à disponibilidade de agenda, com confirmação imediata devido à proximidade da data.</p>
    {foot("Investimento")}
  </section>'''
