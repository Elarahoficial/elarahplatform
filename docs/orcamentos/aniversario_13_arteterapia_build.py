...
# ---- recolor: argila-mauve (arteterapia) ----
head = head.replace("--orange:#F27623;", "--orange:#B07567;")
head = head.replace("--orange-dark:#D4600E;", "--orange-dark:#8F5A4E;")
head = head.replace("--navy:#16233C;", "--navy:#332723;")
head = head.replace("--navy-soft:#3B4E6B;", "--navy-soft:#6B5A53;")
head = head.replace("--blue-accent:#4C6EA3;", "--blue-accent:#B07567;")
head = head.replace("#EDF1F7", "#F6F0EC").replace("#DCE5F1", "#EBDDD5")
head = head.replace("#FF9A4D", "#CFA093")
head = head.replace("rgba(242,118,35,.22)", "rgba(176,117,103,.26)")
...
extra = '''
  ...
  .exp .top{position:absolute;top:11px;left:11px;z-index:3;background:var(--orange);color:#fff;font-size:9px;font-weight:700;letter-spacing:.05em;text-transform:uppercase;padding:5px 11px;border-radius:999px;box-shadow:0 6px 14px -4px rgba(143,90,78,.4)}
  ...
  <section class="slide">
    <div class="slide__head">
      ...
      <div class="head-right">
        <span class="kicker">Proposta de aniversário · 13 anos</span>
        <span class="compass">Vivência <span>Elarah</span><small>Arteterapia criativa</small></span>
      </div>
    </div>
    <div class="cover">
      <div>
        <span class="eyebrow">✦ Aniversário de 13 anos · Vivência de arteterapia</span>
        <h1>Criar, sentir<br>e <em>se expressar</em></h1>
        <p class="lead">Uma tarde delicada e cheia de significado pra celebrar os 13 anos com as amigas: uma <strong>vivência de arteterapia</strong> — argila, pintura e colagem, no ritmo da criação livre. Sem pegada de "aula", puro clima de expressão, conexão e acolhimento. 🌿</p>
        <div class="rule"></div>
        <div class="chips">
          <span class="chip"><b>10</b> meninas</span>
          <span class="chip"><b>21</b> ou <b>28/08</b></span>
          <span class="chip"><b>Vila Madalena</b> · SP</span>
        </div>
      </div>
      <div class="cover-photo">
        <img src="assets/aniv-decor.jpg" alt="Mesa de arte decorada com velas, flores e materiais de criação" style="object-position:center 35%">
      </div>
    </div>
...
experiencias = f'''
  <section class="slide">
    <div class="slide__head">
      <div class="brand"><img src="assets/logo.png" alt="Elarah"></div>
      <div class="head-right"><span class="kicker">A vivência</span></div>
    </div>
    <span class="eyebrow orange">◆ Arteterapia · criação livre</span>
    <h2>Três formas de <em>se expressar</em></h2>
    <p class="lead">Uma vivência que une argila, pintura e colagem no ritmo de cada uma — sem certo ou errado, só criação livre e acolhimento. A gente leva um profissional com olhar sensível, todo o material e a estrutura; cada menina leva pra casa o que criou. 🌿</p>
    <div class="rule"></div>
    <div class="menu">
      {exp("01","modelagemcer.jpg","Argila","Modelar a argila com as mãos — um momento calmo e sensorial pra criar do zero.","Mãos modelando uma peça de argila","center 50%")}
      {exp("02","aquarela1.jpg","Pintura","Cores, aquarela e pincel livre — cada uma pinta o que sente, do jeitinho dela.","Menina pintando flores em aquarela","center 50%")}
      {exp("03","colagem.jpg","Colagem","Recortes, texturas e papéis pra montar uma composição cheia de significado.","Mãos criando uma colagem artística com recortes coloridos","center 50%")}
    </div>
    <div class="note" style="margin-top:14px">◆ Tudo no clima de <b>criação livre</b> — sem pegada de aula. Cada menina explora no seu ritmo e leva pra casa a própria criação. 🌸</div>
    {foot("A vivência")}
  </section>'''
...
vibe = f'''
  <section class="slide">
    ...
    <span class="eyebrow orange">◆ O clima da vivência</span>
    <h2>Um cenário <em>acolhedor</em></h2>
    <p class="lead">Mais do que a atividade: a gente monta um ambiente delicado e aconchegante pra celebração — mesa cheia de charme, materiais lindos e aquele clima gostoso de criar junto, no ritmo de cada uma. 🌿</p>
    <div class="rule"></div>
    <div class="bfeat">
      <div class="bphoto"><img src="assets/desp-hero4.jpg" alt="Mesa de arte montada e decorada, com materiais e mimos" style="object-position:center 40%"></div>
      <div class="bbody">
        <span class="btag soft">Feito com carinho</span>
        <h3>Uma mesa cheia de charme</h3>
        <span class="sub">Ambiente acolhedor &amp; delicado</span>
    ...
    <div class="menu">
      ...
      {exp("Afeto","aniv-experienciaa.jpg","Levar de recordação","A alegria de mostrar o que criou — e guardar de lembrança pra sempre.","Amigas rindo e mostrando o que criaram","center 55%")}
    </div>
...
espacos = f'''
  <section class="slide">
    ...
    <p class="lead">Duas cafeterias parceiras charmosas ou o Bake Studio, um estúdio exclusivo só das meninas — com liberdade pra decorar. É só escolher qual combina mais com a comemoração. 🌿</p>
    <div class="rule"></div>
    <div class="vg">
      <div class="vgc">
      ...
      <div class="vgc hl">
        ...
        <div class="b"><span class="t">★ A partir de R$ 289</span><h3>Bake Studio <span class="sub">cozinha &amp; sala</span></h3><p>Estúdio <b>só de vocês</b>, com cozinha e sala — espaço reservado e liberdade pra decorar.</p></div>
      </div>
    </div>
    <div class="note" style="margin-top:14px">◆ Cada espaço com o seu valor por pessoa. No <b>Betc Havas</b> já entra R$ 50 de voucher de consumo; o <b>Bake Studio</b> é reservado só pras meninas, com coffee break e decoração nos níveis completos. 🌿</div>
    {foot("Onde acontece")}
  </section>'''
...
planos = f'''
  <section class="slide">
    ...
    <p class="lead">Valores por pessoa, com material e condução inclusos — e cada menina sempre leva pra casa a própria criação. É só escolher o espaço e o nível que mais combinam com a comemoração. 🌿</p>
    <div class="rule"></div>
    <table class="itable">
      <thead><tr>
        <th class="corner"></th>
...
personaliza = f'''
  <section class="slide">
    ...
    <p class="lead">A partir do nível com foto, a vivência ganha o registro profissional e a lembrancinha personalizada pra cada menina — dois mimos pra deixar o dia ainda mais especial.</p>
    <div class="rule"></div>
    <div class="plans">
      <div class="plan">
        ...
        <div class="plan-body">
          ...
          <ul class="feat">
            <li>Um fotógrafo cobre a vivência inteira</li>
...
como = f'''
  <section class="slide">
    ...
    <p class="lead">A Elarah cuida de toda a produção pra a vivência ser leve do começo ao fim:</p>
    <div class="rule"></div>
    <div class="steps">
      <div class="step"><div class="num">1</div><h3>Escolham o espaço</h3><p>Cafeteria parceira (Jules ou Betc Havas) ou o Bake Studio exclusivo só de vocês — a gente reserva pro dia 21 ou 28/08.</p></div>
      <div class="step"><div class="num">2</div><h3>A gente leva tudo</h3><p>Um profissional com olhar sensível, argila, tintas, papéis e toda a estrutura. As meninas só chegam e criam.</p></div>
      <div class="step"><div class="num">3</div><h3>Cada uma leva a criação</h3><p>No fim, cada menina leva pra casa o que criou — uma lembrança linda e cheia de significado. 🌿</p></div>
    </div>
    <div class="addon">
      <span class="plus">+</span>
      <div>
        <h4>Sob medida pro dia dela</h4>
        <p>A gente ajusta cada detalhe conforme o número de meninas e o clima que vocês querem pra vivência. É só combinar. 🌿</p>
      </div>
    </div>
    <div class="cta">
      <h2>Bora <em>criar juntas?</em> ✦</h2>
      <p>Me confirma o espaço e o nível, que a gente reserva tudo pro dia 21 ou 28/08.</p>
      <div class="cta-actions">
        <a class="btn-wa" href="https://wa.me/5511914455930?text=Oi%2C%20Elarah!%20Vi%20a%20proposta%20da%20viv%C3%AAncia%20de%20arteterapia%20e%20quero%20fechar%20os%20detalhes." target="_blank" rel="noopener">
          💬 Falar no WhatsApp
        </a>
    ...
    <p class="fineprint">Proposta de aniversário de 13 anos da Elarah — vivência de arteterapia (argila, pintura e colagem, criação livre), para cerca de 10 meninas, no dia 21 ou 28/08 (a combinar), em espaço parceiro na Vila Madalena e região (SP). Cada menina cria e leva pra casa a própria criação. Valores por pessoa. No Jules · Campo Belo: A experiência R$ 199 / Com foto R$ 299 / Completo R$ 399 com lembrancinha. No Betc Havas Café (já com R$ 50 de voucher de consumo): A experiência R$ 249 / Com foto R$ 349 / Completo R$ 449 com lembrancinha. No Bake Studio (espaço exclusivo, experiência + espaço só de vocês): A experiência R$ 289 / Com foto R$ 389 (com foto profissional e coffee break) / Completo R$ 539 com decoração e lembrancinha. Valores por pessoa. Proposta válida mediante confirmação de data e disponibilidade de agenda.</p>
    {foot("Aniversário · 13 anos · 2026")}
  </section>'''

deck = '<div class="deck">\n' + cover + experiencias + vibe + espacos + planos + personaliza + como + '\n\n</div>\n\n'
head = head.replace("<title>Setembro Amarelo · Elarah</title>", "<title>Aniversário 13 anos · Vivência de Arteterapia · Elarah</title>")
head = re.sub(r'<meta name="description" content="[^"]*">', '<meta name="description" content="Proposta da Elarah — vivência de arteterapia (argila, pintura, colagem) para aniversário de 13 anos, no café ou no Bake Studio.">', head)
head = head.replace("</head>",
    ...
    "</style>\n</head>")
html = head + deck + tail
out = "/home/user/elarahplatform/experiencia-arteterapia.html"
