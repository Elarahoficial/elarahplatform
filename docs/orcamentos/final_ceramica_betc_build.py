  ...
  <section class="slide">
    ...
    <div class="bfeat">
      ...
      <div class="bbody">
        ...
        <div class="bnote">◆ <b>Importante:</b> o Betc exige um <b>consumo mínimo obrigatório de R$ 50 por pessoa</b> no café (bebidas e petiscos à escolha). Esse valor <b>não está incluso</b> nos planos — é pago à parte, direto no local.</div>
      </div>
    </div>
...
planos = f'''
  <section class="slide">
    ...
    <div class="bnote" style="margin-top:16px">◆ Os valores dos planos <b>não incluem</b> o consumo mínimo de <b>R$ 50 por pessoa</b> no Betc Havas — ele é <b>obrigatório</b> e cobrado à parte, direto no café.</div>
    <p class="fineprint">Valores por pessoa, para a experiência de modelagem em cerâmica no Betc Havas Café. O consumo mínimo de R$ 50 por pessoa no café é obrigatório e NÃO está incluso nos valores dos planos — pago à parte, no local. Reserva: 50% + 50% até 72h antes · Pix, cartão ou transferência (até 12x) · Duração de 2h a 3h. Data e horário sujeitos à confirmação e disponibilidade de agenda.</p>
    {foot("Investimento")}
  </section>'''
