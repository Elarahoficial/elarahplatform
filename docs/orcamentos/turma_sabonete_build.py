...
extra = '''
  ...
  /* Ateliê (info, sem foto) */
  .atehead{display:flex;gap:14px;margin-top:14px;flex-wrap:wrap}
  .ateaddr{flex:1;min-width:220px;background:var(--card);border:1px solid var(--line);border-radius:14px;padding:14px 18px}
  .ateaddr .al{font-size:9px;letter-spacing:.14em;text-transform:uppercase;font-weight:700;color:var(--orange-dark);margin-bottom:5px}
  .ateaddr h4{font-family:'DM Serif Display',serif;font-weight:400;font-size:17px;color:var(--navy);line-height:1.05}
  .ateaddr p{font-size:12px;color:var(--muted);margin-top:3px;line-height:1.4}
  /* planos (3 tiers) */
  ...
  .tier.hl{border:2px solid var(--navy);background:#F3EFF8}
  ...
  .tier h3{font-family:'DM Serif Display',serif;font-weight:400;font-size:19px;color:var(--navy);line-height:1.06}
  .tier .tp{font-family:'DM Serif Display',serif;font-size:31px;color:var(--ink);line-height:1;margin:10px 0 1px}
  ...
  .tier ul li{position:relative;padding-left:18px;font-size:11.5px;color:var(--ink);line-height:1.34}
...
espacos = f'''
  <section class="slide">
    ...
    <span class="eyebrow orange">◆ No Ateliê Elarah</span>
    <h2>Escolham o <em>plano</em></h2>
    <p class="lead">A experiência acontece no nosso Ateliê, num clima super gostoso — e todo plano já vem com a <strong>taça de vinho</strong> inclusa. É só escolher o quão completo querem o encontro. 🍷</p>
    <div class="atehead">
      <div class="ateaddr"><span class="al">Unidade · Praça da Árvore</span><h4>Praça da Árvore</h4><p>Rua das Rosas, 310 · casa 2</p></div>
      <div class="ateaddr"><span class="al">Unidade · Brooklin</span><h4>Brooklin</h4><p>Rua Indiana, 669</p></div>
    </div>
    <div class="tiers">
      <div class="tier">
        ...
        <ul>
          <li>A experiência de sabonete artesanal</li>
          <li>Todo o <b>material</b> e a condução do profissional</li>
          <li><b>Taça de vinho</b> inclusa</li>
        </ul>
      </div>
      <div class="tier hl">
    ...
    <div class="note" style="margin-top:14px">◆ Valores <b>por pessoa</b>, cada um cria e leva os próprios sabonetes. Fim de semana de setembro a confirmar. 🧼</div>
    {foot("No Ateliê Elarah · Investimento")}
  </section>'''
...
como = f'''
  <section class="slide">
    ...
    <div class="rule"></div>
    <div class="steps">
      <div class="step"><div class="num">1</div><h3>Escolham o plano</h3><p>No Ateliê Elarah (Praça da Árvore ou Brooklin), num fim de semana de setembro — é só escolher o plano que mais combina.</p></div>
    ...
    <div class="cta">
      ...
      <p>Me confirma o plano, a unidade do Ateliê e o fim de semana de setembro que vocês preferem, que a gente reserva e organiza tudo.</p>
    ...
    <p class="fineprint">Proposta de experiência da Elarah para turma privada — workshop de sabonete artesanal, para 5 pessoas, em um fim de semana de setembro (a confirmar), em espaço parceiro. Cada convidado cria e leva os próprios sabonetes, com material e condução do profissional inclusos. Acontece no Ateliê Elarah — Praça da Árvore (Rua das Rosas, 310 · casa 2) ou Brooklin (Rua Indiana, 669). Três planos, por pessoa, todos com taça de vinho inclusa: Com vinho a partir de R$ 239; + Foto &amp; Coffee (foto profissional + coffee break) R$ 389; + Personalização (lembrancinha personalizada) R$ 489. Valores por pessoa. Proposta válida mediante confirmação de data e disponibilidade de agenda.</p>
