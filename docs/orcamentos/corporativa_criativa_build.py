  ...
  <section class="slide">
    <div class="slide__head">
      ...
      <div class="head-right">
        ...
        <span class="compass">Uma pausa <span>criativa</span><small>São Paulo · outubro</small></span>
      </div>
    </div>
    <div class="cover">
      <div>
        <span class="eyebrow">✦ Experiência Corporativa · Integração</span>
        <h1>Criar com as<br>próprias <em>mãos</em></h1>
        <p class="lead">Uma pausa criativa pra <strong>tirar o time da rotina e integrar de verdade</strong> — leve, sensorial e cheia de troca. Cada um escolhe a experiência, cria a sua peça e leva pra casa, num <strong>estúdio só de vocês</strong>. 🌿</p>
        <div class="rule"></div>
        <div class="chips">
          <span class="chip">Turma <b>privativa</b></span>
          <span class="chip"><b>Outubro</b> · a definir</span>
...
buscamos = f'''
  <section class="slide">
    ...
    <p class="lead">Nada aproxima um time como <strong>criar junto com as próprias mãos</strong>. Uma pausa sensorial e criativa pra soltar a equipe, sair da rotina e render boas histórias — pra qualquer um, sem talento nenhum.</p>
    <div class="rule"></div>
    <div class="grid3">
      ...
      <div class="infocard"><div class="ico"><svg viewBox="0 0 28 28" fill="none" stroke="#C0703A" stroke-width="1.6" stroke-linejoin="round"><path d="M14 3.5 L16 12 L24.5 14 L16 16 L14 24.5 L12 16 L3.5 14 L12 12 Z"/></svg></div><h3>Sensorial & manual</h3><p>Mão na massa de verdade — argila, aromas e fios. Criativo, autoral e cheio de estilo.</p></div>
      <div class="infocard"><div class="ico"><svg viewBox="0 0 28 28" fill="none" stroke="#C0703A" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><path d="M5 24 V11 L14 4.5 L23 11 V24"/><rect x="11.5" y="16" width="5" height="8"/></svg></div><h3>Espaço 100% de vocês</h3><p>Um estúdio lindo e totalmente fechado pro time — material, condução e estrutura inclusos.</p></div>
    </div>
    <div class="quote">
      <i>"Os melhores times se constroem fora da mesa de reunião."</i><br>
      — É isso que a Elarah leva: uma pausa que vira <strong>história pra contar no corredor</strong>. 🌿
    </div>
...
planos = f'''
  <section class="slide">
    ...
    <p class="lead">O valor é o mesmo pras quatro experiências — muda só o nível que escolherem. Todos <strong>por pessoa</strong>, já com o <strong>espaço 100% fechado só de vocês</strong>, material e condução inclusos. 🌿</p>
    <div class="rule"></div>
    <table class="itable">
      <thead><tr>
        <th class="corner"></th>
    ...
    <div class="note" style="margin-top:20px">◆ Valores <b>por pessoa</b>, com o <b>espaço 100% fechado e exclusivo pra equipe</b> já incluso, além de material e condução. <b>Níveis:</b> A experiência → <b>+ foto profissional do evento</b> (+R$ 100) → <b>+ personalização & lembrancinha</b> (+R$ 100), no Bake Studio (Bela Vista).</div>
    {foot("Investimento")}
  </section>'''
  ...
  <section class="slide">
    ...
    <div class="plans">
      <div class="plan">
        ...
        <div class="plan-body">
          <span class="tag basic">Nível Com foto · R$ 399</span>
      ...
      <div class="plan featured">
        <span class="ribbon">★ Nível Completo · R$ 499</span>
...
como = f'''
  <section class="slide">
    ...
    <div class="steps">
      ...
      <div class="step"><div class="num">2</div><h3>No Bake Studio</h3><p>A gente reserva o estúdio 100% fechado na Bela Vista e leva material, condução e estrutura — é só chegar.</p></div>
      <div class="step"><div class="num">3</div><h3>O time cria &amp; integra</h3><p>Todo mundo põe a mão na massa e leva a própria criação pra casa. 🌿</p></div>
    </div>
    <div class="addon">
    ...
    <div class="cta">
      <h2>Bora soltar a <em>criatividade?</em> ✦</h2>
      <p>Me conta qual experiência mais chamou e a data de outubro, que a gente fecha cada detalhe do encontro.</p>
    ...
    <p class="fineprint">Proposta de experiência corporativa da Elarah para integração de time, turma privativa, em outubro (data a definir), no Bake Studio (espaço 100% fechado e exclusivo · Rua Conselheiro Ramalho, 378 · Bela Vista · São Paulo). Experiência à escolha, pelo mesmo valor: Modelagem em Cerâmica, Charme de Bolsa, Perfume Natural ou Bolsa de Crochê — cada participante cria e leva a própria peça. A partir de R$ 299 por pessoa (níveis R$ 299 / 399 / 499): A experiência (espaço exclusivo, material e condução) / + foto profissional do evento (+R$ 100) / Completo com personalização e lembrancinha (+R$ 100). O valor é por pessoa e o espaço é 100% da equipe. Inclui um momento para fala do time, sem custo adicional. Proposta válida mediante confirmação de data e disponibilidade de agenda.</p>
