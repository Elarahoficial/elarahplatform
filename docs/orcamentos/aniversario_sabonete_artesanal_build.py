# Aniversário de menina · Sabonete Artesanal · Betc Havas Café. Blush rose palette.
import re
...
# ---- recolor: blush rose (docinho, menina) ----
head = head.replace("--orange:#F27623;", "--orange:#D97B95;")
head = head.replace("--orange-dark:#D4600E;", "--orange-dark:#B85274;")
head = head.replace("--navy:#16233C;", "--navy:#38262E;")
head = head.replace("--navy-soft:#3B4E6B;", "--navy-soft:#6E5860;")
head = head.replace("--blue-accent:#4C6EA3;", "--blue-accent:#D97B95;")
head = head.replace("#EDF1F7", "#FBEFF2").replace("#DCE5F1", "#F3DEE5")
head = head.replace("#FF9A4D", "#E7A0B4")
head = head.replace("rgba(242,118,35,.22)", "rgba(217,123,149,.28)")
...
extra = '''
  ...
  .exp .top{position:absolute;top:11px;left:11px;z-index:3;background:var(--orange);color:#fff;font-size:9px;font-weight:700;letter-spacing:.05em;text-transform:uppercase;padding:5px 11px;border-radius:999px;box-shadow:0 6px 14px -4px rgba(184,82,116,.4)}
  ...
  .dchips span{background:#F8E4EB;border:1px solid var(--line);border-radius:999px;padding:6px 13px;font-size:11.5px;color:var(--navy);font-weight:500}
</style>'''
  ...
  <section class="slide">
    <div class="slide__head">
      ...
      <div class="head-right">
        ...
        <span class="compass">Sabonete <span>Artesanal</span><small>Aniversário criativo</small></span>
      </div>
    </div>
    <div class="cover">
      <div>
        <span class="eyebrow">✦ Aniversário · Workshop de sabonete artesanal</span>
        <h1>Um aniversário<br>que <em>cheira bem</em></h1>
        <p class="lead">Uma comemoração diferente e cheia de charme: a galera se reúne pra um <strong>workshop de sabonete artesanal</strong> — cada uma cria o próprio sabonete, com aromas e botânicos, e leva pra casa de recordação. Puro clima de celebração. 🌸</p>
        <div class="rule"></div>
        <div class="chips">
          <span class="chip"><b>Sabonete</b> artesanal</span>
          <span class="chip">Turma <b>privada</b></span>
          <span class="chip">No <b>Betc Havas Café</b></span>
        </div>
      </div>
      <div class="cover-photo">
        <img src="assets/aniv-infantil.jpg" alt="Meninas criando juntas numa experiência da Elarah" style="object-position:center 25%">
      </div>
    </div>
    ...
    {foot("Aniversário · Sabonete Artesanal")}
  </section>'''
...
workshop = f'''
  <section class="slide">
    ...
    <h2>Aromas que viram <em>arte</em></h2>
    <p class="lead">Uma experiência sensorial e delicada: cada convidada escolhe aromas, cores e botânicos e cria os próprios sabonetes — bonitos de dar de presente (ou de guardar só pra si). A gente leva o profissional, o material e toda a estrutura. 🌸</p>
    <div class="rule"></div>
    <div class="menu">
      {exp("01","sabonete.jpg","Botânicos &amp; aromas","Lavanda, rosas, alecrim, aveia — uma mesa cheia de cheirinhos pra escolher e misturar.","Cesta de sabonetes artesanais com lavanda e alecrim","center 50%")}
      {exp("02","sabonete3.jpg","Delicados &amp; lindos","Pétalas de verdade e cores suaves deixam cada sabonete único e cheio de charme.","Sabonete artesanal rosa com botões de rosa","center 50%")}
      {exp("03","saboneteroxo.jpg","Do seu jeito","Cada uma cria os próprios — com o aroma e o formato que mais combinam com ela.","Sabonetes artesanais de lavanda","center 50%")}
    </div>
    <div class="note" style="margin-top:14px">◆ Estas são <b>inspirações</b> — na hora, cada convidada cria os próprios sabonetes, do jeitinho dela, e leva pra casa. 🌸</div>
    {foot("O workshop")}
  </section>'''
...
espaco = f'''
  <section class="slide">
    ...
    <p class="lead">A sugestão perfeita pra celebrar: um café <strong>moderno e cheio de charme</strong>, com madeira, arte autoral nas paredes e cantinhos <strong>bem aconchegantes</strong> pra sentar e ficar. O cenário ideal pra criar, cheirar e comemorar. ☕</p>
    <div class="rule"></div>
...
planos = f'''
  <section class="slide">
    ...
    <p class="lead">Escolha o nível que combina com a comemoração — do essencial ao completo. Valor por pessoa, com material e condução inclusos, e cada convidada leva os próprios sabonetes. 🌸</p>
    <div class="rule"></div>
    <table class="itable">
      <thead><tr>
        <th class="corner"></th>
      ...
      <tbody><tr>
        <td class="rl"><b>Sabonete artesanal</b><span>Cada convidada cria e leva os próprios sabonetes</span></td>
        <td class="val">R$ 199</td><td class="val">R$ 299</td><td class="val hl">R$ 399</td>
      </tr></tbody>
    </table>
    <div class="note" style="margin-top:18px">◆ Valor <b>por pessoa</b>, com material e condução inclusos. O nível <b>Com foto &amp; voucher</b> soma a foto profissional do encontro e um voucher de R$ 30 de consumo por pessoa; o <b>Completo</b> soma também a lembrancinha personalizada. Realizado no Betc Havas Café, em data a combinar.</div>
    {foot("Investimento")}
  </section>'''
...
como = f'''
  <section class="slide">
    ...
    <div class="rule"></div>
    <div class="steps">
      <div class="step"><div class="num">1</div><h3>Marcamos a data</h3><p>A gente reserva o Betc Havas Café pra sua turma privada, no dia que combinar melhor.</p></div>
      <div class="step"><div class="num">2</div><h3>A gente leva tudo</h3><p>Profissional, bases, aromas, botânicos e toda a estrutura. Vocês só chegam e criam.</p></div>
      <div class="step"><div class="num">3</div><h3>Cada uma leva o mimo</h3><p>No fim, todas levam pra casa os próprios sabonetes — uma lembrança cheirosa do dia. 🌸</p></div>
    </div>
    <div class="addon">
      <span class="plus">+</span>
      <div>
        <h4>Sob medida pro seu dia</h4>
        <p>A gente ajusta cada detalhe conforme o número de convidadas e o clima que você quer pra festa. É só combinar. 🌸</p>
      </div>
    </div>
    <div class="cta">
      <h2>Bora <em>criar e comemorar?</em> ✦</h2>
      <p>Me confirma o número de convidadas e a data, que a gente reserva o café e organiza tudo.</p>
    ...
    <p class="fineprint">Proposta de aniversário da Elarah — workshop de sabonete artesanal, para uma turma privada, no Betc Havas Café (data a combinar). Cada convidada cria e leva os próprios sabonetes. A partir de R$ 199 por pessoa (níveis R$ 199 / 299 / 399): A experiência (material e condução) / + foto profissional e R$ 30 de voucher de consumo por pessoa / Completo com lembrancinha personalizada. Valor por pessoa. Proposta válida mediante confirmação de data e disponibilidade de agenda.</p>
    {foot("Aniversário · Sabonete Artesanal · 2026")}
  </section>'''

deck = '<div class="deck">\n' + cover + workshop + espaco + planos + personaliza + como + '\n\n</div>\n\n'
head = head.replace("<title>Setembro Amarelo · Elarah</title>", "<title>Sabonete Artesanal · Aniversário · Elarah</title>")
head = re.sub(r'<meta name="description" content="[^"]*">', '<meta name="description" content="Proposta de aniversário da Elarah — workshop de sabonete artesanal no Betc Havas Café.">', head)
head = head.replace("</head>",
    ...
    "</style>\n</head>")
html = head + deck + tail
out = "/home/user/elarahplatform/experiencia-sabonete-artesanal.html"
