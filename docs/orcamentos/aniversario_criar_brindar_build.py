...
harmoniza = f'''
  <section class="slide">
    ...
    <div class="bfeat" style="height:240px">
      <div class="bphoto"><img src="assets/harmonizacaoqueijos.jpg" alt="Tábua de queijos artesanais numa degustação" style="object-position:center 60%"></div>
      <div class="bbody">
...
planos = f'''
  <section class="slide">
    ...
    <div class="vtitle">Experiências manuais <span>vela · pintura em taça · cerâmica</span></div>
    <table class="itable">
      <thead><tr>
        <th class="corner"></th>
    ...
    <div class="note" style="margin-top:10px">◆ No <b>Betc Havas Café</b> a comida é à parte. No <b>Bake Studio</b> o espaço é exclusivo (cozinha e sala) e o <b>Completo (R$ 499)</b> já inclui foto profissional &amp; lembrancinha.</div>
...
personaliza = f'''
  <section class="slide">
    ...
    <div class="plans">
      <div class="plan">
        <div class="plan-photo sq"><img src="assets/rockworld3.jpg" alt="Amigas brindando juntas, registrado por um fotógrafo" style="object-position:center 40%"></div>
        <div class="plan-body">
