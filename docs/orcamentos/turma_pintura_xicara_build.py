# Turma privada · Pintura em Xícara · 7 pessoas · 15/8 · Betc Havas Café. Caramelo palette.
import re
...
# ---- recolor: caramelo / café (aconchegante) ----
head = head.replace("--orange:#F27623;", "--orange:#B07A4E;")
head = head.replace("--orange-dark:#D4600E;", "--orange-dark:#895226;")
head = head.replace("--navy:#16233C;", "--navy:#322619;")
head = head.replace("--navy-soft:#3B4E6B;", "--navy-soft:#6E5E4C;")
head = head.replace("--blue-accent:#4C6EA3;", "--blue-accent:#B07A4E;")
head = head.replace("#EDF1F7", "#F6F0E6").replace("#DCE5F1", "#EBDFC9")
head = head.replace("#FF9A4D", "#CBA063")
head = head.replace("rgba(242,118,35,.22)", "rgba(176,122,78,.28)")
...
extra = '''
  ...
  .exp .top{position:absolute;top:11px;left:11px;z-index:3;background:var(--orange);color:#fff;font-size:9px;font-weight:700;letter-spacing:.05em;text-transform:uppercase;padding:5px 11px;border-radius:999px;box-shadow:0 6px 14px -4px rgba(137,82,38,.4)}
  ...
  .dchips span{background:#F3E9D6;border:1px solid var(--line);border-radius:999px;padding:6px 13px;font-size:11.5px;color:var(--navy);font-weight:500}
</style>'''
  ...
  <section class="slide">
    <div class="slide__head">
      ...
      <div class="head-right">
        ...
        <span class="compass">Pintura <span>em xícara</span><small>Turma privada</small></span>
      </div>
    </div>
    <div class="cover">
      <div>
        <span class="eyebrow">✦ Experiência criativa · Pintura em xícara</span>
        <h1>Um encontro<br>que <em>fica</em></h1>
        <p class="lead">Uma tarde criativa e cheia de afeto pra turma: um <strong>workshop de pintura em xícara</strong>, onde cada um personaliza a própria xícara e leva pra casa de lembrança. Puro clima de encontro, café e boas conversas. ☕</p>
        <div class="rule"></div>
        <div class="chips">
          <span class="chip"><b>7</b> pessoas</span>
          <span class="chip"><b>15/08</b></span>
    ...
    {foot("Turma privada · Pintura em xícara")}
  </section>'''
...
workshop = f'''
  <section class="slide">
    ...
    <span class="eyebrow orange">◆ Pintura em xícara</span>
    <h2>Cada xícara, <em>uma arte</em></h2>
    <p class="lead">Com tintas próprias pra cerâmica, cada convidado cria a própria xícara — de flores delicadas a padrões coloridos, do jeitinho de cada um. A gente leva o profissional, o material e toda a estrutura; vocês só chegam e pintam. ☕🎨</p>
    <div class="rule"></div>
    <div class="menu">
      {exp("01","xicarapintada.jpg","Cada xícara, única","Listras, cores e padrões — cada um cria a própria xícara, do jeitinho dele.","Xícaras de cerâmica pintadas à mão com listras coloridas","center 50%")}
      {exp("02","ceramicacool.jpg","Do seu jeito","Nomes, frases e cores favoritas deixam cada peça com a cara de quem pintou.","Peças de cerâmica pintadas à mão com padrões coloridos","center 50%")}
    </div>
    <div class="note" style="margin-top:14px">◆ Estas são <b>inspirações</b> — na hora, cada convidado pinta a própria xícara, livre e do jeitinho dele, e leva pra casa. ☕</div>
    {foot("O workshop")}
  </section>'''
...
espaco = f'''
  <section class="slide">
    ...
    <p class="lead">Dois espaços parceiros lindos, cada um com seu clima — a cafeteria charmosa ou o estúdio só de vocês. É só escolher qual combina mais com o encontro. ☕</p>
    <div class="rule"></div>
...
planos = f'''
  <section class="slide">
    ...
    <p class="lead">Valor por pessoa, com material e condução inclusos — e cada convidado sempre leva a própria xícara. É só escolher o espaço e o nível que mais combinam com a turma. ☕</p>
    <div class="rule"></div>
    <table class="itable">
      <thead><tr>
        <th class="corner"></th>
    ...
    <div class="note" style="margin-top:18px">◆ Valor <b>por pessoa</b>, com material e condução inclusos, na experiência de pintura em xícara. No <b>Betc Havas Café</b> a comida é à parte; o nível Com foto soma a foto profissional e R$ 30 de voucher de consumo, e o Completo soma a lembrancinha. No <b>Bake Studio</b> (cozinha e sala) o espaço é exclusivo, e o Completo (R$ 499) já inclui foto profissional &amp; lembrancinha. Data 15/08 a confirmar.</div>
    {foot("Investimento")}
  </section>'''
...
personaliza = f'''
  <section class="slide">
    ...
    <div class="plans">
      <div class="plan">
        <div class="plan-photo sq"><img src="assets/rockworld3.jpg" alt="Encontro registrado por um fotógrafo" style="object-position:center 40%"></div>
        <div class="plan-body">
          <h3>Foto profissional &amp; voucher</h3>
          <span class="tag basic">Nível Com foto · R$ 299</span>
          <ul class="feat">
            <li>Um fotógrafo cobre o encontro inteiro</li>
            <li>Cada risada e cada xícara registradas</li>
...
como = f'''
  <section class="slide">
    ...
    <div class="rule"></div>
    <div class="steps">
      <div class="step"><div class="num">1</div><h3>Escolham o espaço</h3><p>Betc Havas Café ou o Bake Studio exclusivo (cozinha e sala) — a gente reserva pra sua turma no dia 15/08.</p></div>
      <div class="step"><div class="num">2</div><h3>A gente leva tudo</h3><p>Profissional, tintas, xícaras e toda a estrutura do workshop. Vocês só chegam e pintam.</p></div>
      <div class="step"><div class="num">3</div><h3>Cada um leva a xícara</h3><p>No fim, todo mundo leva pra casa a própria xícara pintada — uma lembrança linda do dia. ☕</p></div>
    </div>
    <div class="addon">
    ...
    <div class="cta">
      ...
      <p>Me confirma o número de convidados, que a gente reserva o café e organiza tudo pro dia 15/08.</p>
      <div class="cta-actions">
        <a class="btn-wa" href="https://wa.me/5511914455930?text=Oi%2C%20Elarah!%20Vi%20a%20proposta%20do%20workshop%20de%20pintura%20em%20x%C3%ADcara%20e%20quero%20fechar." target="_blank" rel="noopener">
          💬 Falar no WhatsApp
        </a>
    ...
    <p class="fineprint">Proposta de experiência da Elarah para turma privada — workshop de pintura em xícara, para 7 pessoas, em 15/08 (a confirmar), em espaço parceiro. Cada convidado pinta e leva a própria xícara. Opção 1 · Betc Havas Café (comida à parte): a partir de R$ 199 por pessoa (R$ 199 / 299 / 399 — A experiência / + foto profissional e R$ 30 de voucher / Completo com lembrancinha). Opção 2 · Bake Studio (Bela Vista, cozinha e sala), espaço exclusivo: a partir de R$ 279 por pessoa (Completo por R$ 499 com foto e lembrancinha). Valores por pessoa. Proposta válida mediante confirmação de data e disponibilidade de agenda.</p>
    {foot("Turma privada · Pintura em xícara · 2026")}
  </section>'''

deck = '<div class="deck">\n' + cover + workshop + espaco + planos + personaliza + como + '\n\n</div>\n\n'
head = head.replace("<title>Setembro Amarelo · Elarah</title>", "<title>Pintura em Xícara · Turma privada · Elarah</title>")
head = re.sub(r'<meta name="description" content="[^"]*">', '<meta name="description" content="Proposta da Elarah — workshop de pintura em xícara para turma privada no Betc Havas Café.">', head)
head = head.replace("</head>",
    ...
    "</style>\n</head>")
html = head + deck + tail
out = "/home/user/elarahplatform/experiencia-pintura-xicara.html"
