# Turma privada · Modelagem em Cerâmica · 6-7 pessoas · 29/08. 3 tiers de espaço (Ateliê/Jules/Sterna 239, Betc 289, Bake 339). Sage-grey palette.
import re
  ...
  <section class="slide">
    ...
    <div class="cover">
      <div>
        ...
        <div class="rule"></div>
        <div class="chips">
          <span class="chip"><b>6–7</b> pessoas</span>
...
head = head.replace("</head>",
    ...
    "</style>\n</head>")
html = head + deck + tail
out = "/home/user/elarahplatform/experiencia-turma-ceramica-agosto.html"
