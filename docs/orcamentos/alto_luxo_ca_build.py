...
vibe = f'''
  <section class="slide">
    ...
    <div class="vibe">
      <figure><img src="assets/desp-hero2.jpg" alt="Amigas se abraçando e rindo num encontro Elarah" style="object-position:center 22%"><figcaption>Conexão de verdade</figcaption></figure>
