    ...
    <div class="cover">
      <div>
        ...
        <div class="chips">
          ...
          <span class="chip">Baker Studio · <b>São Paulo</b></span>
        </div>
      </div>
...
espacos = f'''
  <section class="slide">
    ...
    <h2>No <em>Baker Studio</em></h2>
    <p class="lead">Um estúdio lindo com <strong>cozinha equipada e lounge acolhedor</strong>, totalmente reservado pro time. O cenário perfeito pra cozinhar, comer junto e relaxar — com toda a estrutura pronta pra receber vocês.</p>
    <div class="rule"></div>
    <div class="bfeat" style="height:230px">
      <div class="bphoto"><img src="assets/espa%C3%A7o2.jpg" alt="Cozinha equipada do Baker Studio" style="object-position:center 50%"></div>
      <div class="bbody">
        <span class="btag">★ Espaço exclusivo incluso</span>
        <h3>Baker Studio <span class="sub">cozinha equipada</span></h3>
    ...
    <div class="bfeat plain" style="margin-top:16px;height:190px">
      <div class="bphoto"><img src="assets/espaco1.jpg" alt="Lounge acolhedor do Baker Studio" style="object-position:center 55%"></div>
      <div class="bbody">
    ...
    {foot("Onde acontece · Baker Studio")}
  </section>'''
...
planos = f'''
  <section class="slide">
    ...
    <div class="note" style="margin-top:20px">◆ Os dois níveis já incluem <b>espaço exclusivo no Baker Studio, entradinha de boas-vindas, a experiência completa, material e condução</b>. O nível Completo soma a <b>foto profissional do evento</b> e um <b>brinde personalizado</b> com a marca. Valores por pessoa, turma de ~30.</div>
    {foot("Investimento")}
  </section>'''
...
como = f'''
  <section class="slide">
    ...
    <div class="steps">
      ...
      <div class="step"><div class="num">2</div><h3>No Baker Studio</h3><p>A gente reserva o estúdio com cozinha equipada e leva material, condução e estrutura — é só chegar.</p></div>
...
head = re.sub(r'<meta name="description"[^>]*>', '<meta name="description" content="Proposta de experiência corporativa gastronômica da Elarah — aula de cozinha ou drinks no Baker Studio.">', head)
html = head + deck + tail
