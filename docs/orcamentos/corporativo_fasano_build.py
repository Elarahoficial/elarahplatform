    ...
    <table class="itable cx">
      ...
      <tbody>
        <tr>
          ...
          <td class="val">R$ 329</td>
          <td class="val">R$ 519<small>+ foto, coffee break &amp; mesa montada</small></td>
          <td class="val hl">R$ 649<small>+ lembrancinha personalizada</small></td>
        </tr>
      </tbody>
    </table>
