...
menu = f'''
  <section class="slide">
    ...
    <h2>Três opções <em>criativas</em></h2>
    <p class="lead">Selecionei três experiências que combinam com um público que respira design — <strong>sensoriais, autorais e cheias de estilo</strong>. Escolham a preferida (ou a gente combina uma estação de cada!).</p>
    <div class="rule"></div>
    <div class="wtrio">
      <div class="wcard"><div class="sq"><img src="assets/perfumariaharbolita.jpg" alt="Essências e frascos de uma imersão de perfumaria botânica" style="object-position:center 45%"></div><div class="wcard-body"><span class="n">01</span><h3>Perfumaria Botânica</h3><p>Cada um cria a própria fragrância, numa imersão sensorial guiada. Casa lindo com o jardim.</p></div></div>
      <div class="wcard"><div class="sq"><img src="assets/ceramicamodelagem.jpg" alt="Mãos modelando uma peça de cerâmica" style="object-position:center 50%"></div><div class="wcard-body"><span class="n">02</span><h3>Cerâmica</h3><p>Modelam a própria peça à mão — forma, material e tato. Praticamente arquitetura em miniatura.</p></div></div>
...
planos = f'''
  <section class="slide">
    ...
    <table class="itable">
      ...
      <tbody>
        <tr>
          <td class="rl"><b>Cerâmica</b><span>Modelagem à mão — forma & material</span></td>
        ...
        <tr>
          <td class="rl"><b>Tufting</b><span>Objeto de design autoral</span></td>
          <td class="val">R$ 589</td><td class="val">R$ 689</td><td class="val hl">R$ 789</td>
        </tr>
      </tbody>
    </table>
    <div class="note" style="margin-top:15px">◆ <b>Níveis:</b> Só a experiência → <b>+ coffee break & foto profissional</b> (+R$ 100) → <b>+ personalização da marca</b> (+R$ 100). Valores por pessoa, turma de 15, no jardim de vocês.</div>
    {foot("Investimento")}
  </section>'''
...
como = f'''
  <section class="slide">
    ...
    <div class="rule"></div>
    <div class="steps">
      <div class="step"><div class="num">1</div><h3>Escolhem a experiência</h3><p>Perfumaria Botânica, Cerâmica ou Tufting — no nível que preferirem.</p></div>
    ...
    <p class="fineprint">Proposta de experiência corporativa da Elarah para relacionamento com arquitetos parceiros da marca, turma de cerca de 15 convidados, na 2ª quinzena de setembro, no jardim da empresa (cerca de 2h30 a 3h). Experiência à escolha: Cerâmica (a partir de R$ 199 · níveis R$ 199 / 299 / 399), Perfumaria Botânica (a partir de R$ 239 · níveis R$ 239 / 339 / 439) ou Tufting (a partir de R$ 589 · níveis R$ 589 / 689 / 789). Níveis: Só a experiência (material & condução inclusos) / + coffee break & foto profissional (+R$ 100) / + personalização da marca (+R$ 100). Valores por pessoa. A Elarah leva material, condução, estrutura e montagem até o local. Inclui um momento para fala da marca, sem custo adicional. Proposta válida mediante confirmação de data (2ª quinzena de setembro) e disponibilidade de agenda.</p>
