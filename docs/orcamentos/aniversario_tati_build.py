...
# ---- recolor: azul-sereno (aniversário) ----
head = head.replace("--orange:#F27623;", "--orange:#6E86AD;")
head = head.replace("--orange-dark:#D4600E;", "--orange-dark:#516A92;")
head = head.replace("--navy:#16233C;", "--navy:#232B36;")
head = head.replace("--navy-soft:#3B4E6B;", "--navy-soft:#54606F;")
head = head.replace("--blue-accent:#4C6EA3;", "--blue-accent:#6E86AD;")
head = head.replace("#EDF1F7", "#EFF2F7").replace("#DCE5F1", "#DCE4EF")
head = head.replace("#FF9A4D", "#9DB2CE")
head = head.replace("rgba(242,118,35,.22)", "rgba(110,134,173,.26)")
...
extra = '''
  ...
  .exp .top{position:absolute;top:11px;left:11px;z-index:3;background:var(--orange);color:#fff;font-size:9px;font-weight:700;letter-spacing:.05em;text-transform:uppercase;padding:5px 11px;border-radius:999px;box-shadow:0 6px 14px -4px rgba(81,106,146,.4)}
  ...
  <section class="slide">
    <div class="slide__head">
      ...
      <div class="head-right">
        ...
        <span class="compass">Aniversário <span>Elarah</span><small>Taça &amp; perfumaria</small></span>
      </div>
    </div>
    <div class="cover">
      <div>
        <span class="eyebrow">✦ Aniversário · Pintura em taça ou Perfumaria</span>
        <h1>Comemorar<br>com as <em>mãos</em></h1>
        <p class="lead">Um aniversário diferente e cheio de charme pra você e a galera: uma <strong>experiência criativa</strong> — pintura em taça ou perfumaria — pra colocar a mão na massa, brindar e comemorar. Cada uma cria e leva a própria recordação. 🥂</p>
        <div class="rule"></div>
        <div class="chips">
          <span class="chip"><b>10</b> pessoas</span>
          <span class="chip"><b>Em setembro</b></span>
...
experiencias = f'''
  <section class="slide">
    ...
    <h2>Pintura em taça <em>ou</em> perfumaria</h2>
    <p class="lead">Duas experiências criativas e cheias de charme pra escolher — <strong>pelo mesmo valor por pessoa</strong>. A gente guia tudo do começo ao fim, e cada uma leva a própria criação de recordação. 🥂</p>
    <div class="rule"></div>
    <div class="menu">
      {exp("01","pinturataca2.jpg","Pintura em taça","Cada uma pinta a própria taça com flores e cores — delicada e cheia de charme pra brindar.","Taças de vinho pintadas à mão com flores coloridas","center 50%")}
      {exp("02","perfumariamaes.jpg","Perfumaria","Criar o próprio perfume com notas que amam — uma fragrância única pra levar pra casa.","Mesa de perfumaria com essências, pétalas e flores","center 50%")}
    </div>
...
espacos = f'''
  <section class="slide">
    ...
    <p class="lead">Duas cafeterias parceiras charmosas ou o Bake Studio, um estúdio exclusivo só da turma. É só escolher qual combina mais com a comemoração. 🥂</p>
    <div class="rule"></div>
    <div class="vg">
      <div class="vgc">
...
como = f'''
  <section class="slide">
    ...
    <div class="rule"></div>
    <div class="steps">
      <div class="step"><div class="num">1</div><h3>Escolham a experiência</h3><p>Pintura em taça ou perfumaria — pelo mesmo valor. A gente leva profissional, material e estrutura.</p></div>
      <div class="step"><div class="num">2</div><h3>Escolham o espaço</h3><p>Cafeteria parceira (Jules ou Betc Havas) ou o Bake Studio exclusivo só de vocês, em setembro.</p></div>
    ...
    <div class="cta">
      ...
      <p>Me confirma a experiência, o espaço e a data (em setembro), que a gente organiza tudo.</p>
...
head = head.replace("</head>",
    ...
    "</style>\n</head>")
html = head + deck + tail
out = "/home/user/elarahplatform/experiencia-aniversario-tati.html"
