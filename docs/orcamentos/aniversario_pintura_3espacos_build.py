# Aniversário · Pintura · 19 ou 22/08. 3 espaços (Jules 199 / Betc 249 / Bake consultar). Raspberry palette.
import re
...
# ---- recolor: framboesa / rosa-vibrante (festivo) ----
head = head.replace("--orange:#F27623;", "--orange:#C15570;")
head = head.replace("--orange-dark:#D4600E;", "--orange-dark:#9A3A54;")
head = head.replace("--navy:#16233C;", "--navy:#331E26;")
head = head.replace("--navy-soft:#3B4E6B;", "--navy-soft:#6E5560;")
head = head.replace("--blue-accent:#4C6EA3;", "--blue-accent:#C15570;")
head = head.replace("#EDF1F7", "#F9EEF1").replace("#DCE5F1", "#F0D9E0")
head = head.replace("#FF9A4D", "#D68DA0")
head = head.replace("rgba(242,118,35,.22)", "rgba(193,85,112,.28)")
...
extra = '''
  ...
  .exp .top{position:absolute;top:11px;left:11px;z-index:3;background:var(--orange);color:#fff;font-size:9px;font-weight:700;letter-spacing:.05em;text-transform:uppercase;padding:5px 11px;border-radius:999px;box-shadow:0 6px 14px -4px rgba(154,58,84,.4)}
  ...
  .itable .consult{font-family:'DM Sans';font-size:14px;font-weight:700;color:var(--orange-dark);letter-spacing:.01em}
  .itable .hl{background:#F6E4EA}
...
head = head.replace(".plans{grid-template-columns:1fr}", ".plans{grid-template-columns:1fr}")
  ...
  <section class="slide">
    ...
    <div class="cover">
      <div>
        ...
        <div class="rule"></div>
        <div class="chips">
          <span class="chip"><b>Pintura</b></span>
          <span class="chip"><b>19</b> ou <b>22/08</b></span>
...
espacos = f'''
  <section class="slide">
    ...
    <p class="lead">Três espaços parceiros lindos, cada um com seu charme e seu valor. É só escolher qual combina mais com a comemoração — do café arejado ao estúdio exclusivo. 🎨</p>
    <div class="rule"></div>
    <div class="menu">
      ...
      {exp("Opção 3","espaco1.jpg","Bake Studio","Estúdio exclusivo com <b>cozinha e sala</b>, só de vocês, com liberdade pra decorar.","Lounge acolhedor do Bake Studio","center 55%",top="Consultar")}
    </div>
    <div class="note" style="margin-top:14px">◆ Cada espaço tem o seu valor por pessoa. No <b>Jules</b> o consumo é à parte; o <b>Betc</b> já vem com R$ 50 de consumação; o <b>Bake Studio</b> é exclusivo só de vocês — valor conforme o número de pessoas. 🎨</div>
    {foot("Onde acontece")}
  </section>'''
...
planos = f'''
  <section class="slide">
    ...
    <p class="lead">Valor por pessoa, com material e condução inclusos — e cada um sempre leva a própria peça. É só escolher o espaço e o nível que mais combinam com a comemoração. 🎨</p>
    <div class="rule"></div>
    <table class="itable">
      <thead><tr>
        <th class="corner"></th>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td class="consult hl" colspan="3">Consultar conforme o nº de pessoas</td>
        </tr>
      </tbody>
    </table>
    <div class="note" style="margin-top:16px">◆ Valor <b>por pessoa</b>, com material e condução inclusos. O nível <b>Com foto</b> soma a foto profissional (+R$ 50) e o <b>Completo</b> soma a lembrancinha (+R$ 100). No <b>Bake Studio</b>, por ser espaço exclusivo, o valor é calculado conforme o <b>número de pessoas</b> — me conta quantas são que eu já fecho. Datas 19/08 ou 22/08 a confirmar.</div>
    {foot("Investimento")}
  </section>'''
...
como = f'''
  <section class="slide">
    ...
    <div class="rule"></div>
    <div class="steps">
      <div class="step"><div class="num">1</div><h3>Escolham o espaço</h3><p>Jules (Campo Belo), Betc Havas Café ou o Bake Studio exclusivo — a gente reserva pra sua festa.</p></div>
    ...
    <div class="cta">
      ...
      <p>Me confirma o espaço, a data (19 ou 22/08) e o número de convidados, que a gente fecha tudo pra você.</p>
    ...
    <p class="fineprint">Proposta de aniversário da Elarah — workshop de pintura (em taça, xícara, caneca, prato de cerâmica e mais), em 19/08 ou 22/08 (a confirmar), em espaço parceiro. Cada convidado pinta e leva a própria peça. Três opções de espaço, por pessoa: Jules · Campo Belo (consumo à parte) a partir de R$ 199; Betc Havas Café (R$ 50 de consumação inclusos) a partir de R$ 249; Bake Studio (Bela Vista, cozinha e sala), espaço exclusivo, com valor a consultar conforme o número de pessoas. Em todas, o nível Com foto soma a foto profissional (+R$ 50) e o Completo soma a lembrancinha (+R$ 100). Valores por pessoa. Proposta válida mediante confirmação de data, número de participantes e disponibilidade de agenda.</p>
...
head = re.sub(r'<meta name="description" content="[^"]*">', '<meta name="description" content="Proposta de aniversário da Elarah — workshop de pintura no Jules, Betc Havas ou Bake Studio.">', head)
head = head.replace("</head>",
    ...
    "</style>\n</head>")
html = head + deck + tail
out = "/home/user/elarahplatform/experiencia-aniversario-pintura2.html"
