...
{head_simple("Investimento")}
    ...
    <h2>Escolham o espaço e a <em>experiência</em></h2>
    <p class="lead">Duas formas de viver esse encontro, com tudo já organizado pela Elarah — experiência, materiais, espaço e comidinhas incluídas.</p>
    <div class="invblocks">
      <div class="invb">
        <span class="ibsp">Entre Mãos · Perdizes</span>
        <div class="ibsub">Experiência + espaço + comidinhas e bebidas</div>
        <div class="ibrows">
          <div class="invrow"><span class="ie">Cerâmica</span><span class="iv"><span class="pp">R$ 439</span><span class="ppu">por pessoa</span><span class="tg">R$ 3.512 · grupo de 8</span></span></div>
          <div class="invrow"><span class="ie">Perfumaria Botânica</span><span class="iv"><span class="pp">R$ 509</span><span class="ppu">por pessoa</span><span class="tg">R$ 4.072 · grupo de 8</span></span></div>
          <div class="invrow"><span class="ie">Arranjos florais</span><span class="iv"><span class="pp">R$ 399</span><span class="ppu">por pessoa</span><span class="tg">R$ 3.192 · grupo de 8</span></span></div>
        </div>
        <p class="ibnote">Inclui espaço, materiais, condução da experiência, lanchinho, sucos, café e chá.</p>
      </div>
      <div class="invb">
        <span class="ibsp">Agora Intu · Pinheiros</span>
        <div class="ibsub">Experiência + espaço exclusivo + finger food</div>
        <div class="ibrows">
          <div class="invrow"><span class="ie">Cerâmica</span><span class="iv"><span class="pp">R$ 539</span><span class="ppu">por pessoa</span><span class="tg">R$ 4.312 · grupo de 8</span></span></div>
          <div class="invrow"><span class="ie">Arranjos florais</span><span class="iv"><span class="pp">R$ 509</span><span class="ppu">por pessoa</span><span class="tg">R$ 4.072 · grupo de 8</span></span></div>
        </div>
        <p class="ibnote">Inclui espaço exclusivo, materiais, condução da experiência, café, chá, água e 5 bites quentes e frios servidos ao longo do encontro.</p>
      </div>
    </div>
    <p class="fineprint">Valores finais para 8 participantes, já considerando toda a composição da experiência.</p>
    {foot("Investimento")}
  </section>'''
