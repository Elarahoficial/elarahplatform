    ...
    <div class="bfeat">
      ...
      <div class="bbody">
        ...
        <ul class="feat">
          ...
          <li><span class="st">✦</span>Todos os <b>materiais inclusos</b> e a queima das peças.</li>
          <li><span class="st">✦</span>Cada um leva <b>a própria peça</b> de recordação.</li>
        </ul>
      </div>
    </div>
    {foot("A experiência")}
...
{head_simple("Investimento")}
    ...
    <h2>Escolham como <em>completar</em> essa experiência</h2>
    <div class="subline">02/10 · 16h às 19h30 · Entre Mãos, Perdizes</div>
    <p class="lead">A experiência de cerâmica já está escolhida. Agora vocês podem seguir com o formato original ou complementar o encontro com um mimo personalizado e registro profissional.</p>
    <div class="pkgs">
      <div class="pkg">
        <span class="pkn">01 · Experiência</span>
        <div class="pkt">Cerâmica no Entre Mãos</div>
        <div class="pkp">R$ 439</div>
        <div class="pku">por pessoa</div>
        <div class="pktot">R$ 3.512 · grupo de 8</div>
        <div class="pkstep">O formato escolhido pela Segatta.</div>
        <ul>
          <li>Experiência de cerâmica + materiais</li>
          <li>Condução + assistente</li>
          <li>Espaço reservado</li>
          <li>Lanchinho, sucos, café e chá</li>
        </ul>
      </div>
      <div class="pkg hl">
        <span class="pkbadge">Mais escolhido</span>
        <span class="pkn">02 · Premium</span>
        <div class="pkt">Experiência + mimo personalizado</div>
        <div class="pkp">R$ 568</div>
        <div class="pku">por pessoa</div>
        <div class="pktot">R$ 4.544 · grupo de 8</div>
        <div class="pkstep">Experiência + R$ 129/pessoa do mimo.</div>
        <ul>
          <li>Tudo do pacote Experiência</li>
          <li>1 mimo personalizado por participante</li>
          <li>Garrafinha, vela ou home spray</li>
          <li>Com a identidade da Segatta</li>
        </ul>
      </div>
      <div class="pkg">
        <span class="pkn">03 · Completo</span>
        <div class="pkt">Experiência + mimo + registro profissional</div>
        <div class="pkp">R$ 605,38</div>
        <div class="pku">por pessoa</div>
        <div class="pktot">R$ 4.843 · grupo de 8</div>
        <div class="pkstep">Premium + R$ 299 do registro em vídeo.</div>
        <ul>
          <li>Tudo do pacote Premium</li>
          <li>Registro profissional em vídeo</li>
          <li>Vídeo editado entregue depois</li>
          <li>A memória do encontro pra guardar</li>
        </ul>
      </div>
    </div>
    <p class="fineprint">Valores para 8 participantes.</p>
    {foot("Investimento")}
  </section>'''
...
{head_simple("Como funciona & contato")}
    ...
    <div class="rule"></div>
    <div class="steps">
      <div class="step"><div class="num">1</div><h3>Escolham o pacote</h3><p>Experiência, Premium ou Completo — a data e o espaço já estão confirmados: 02/10, no Entre Mãos.</p></div>
      <div class="step"><div class="num">2</div><h3>A gente leva tudo</h3><p>Ceramista, todo o material e a estrutura. Chegamos antes, montamos e desmontamos no fim.</p></div>
      <div class="step"><div class="num">3</div><h3>Cada um leva a sua criação</h3><p>Cada participante sai com a própria peça de cerâmica e uma lembrança desse encontro.</p></div>
    </div>
    <div class="addon">
    ...
    <div class="cta">
      ...
      <p>Vi, me confirma o pacote que faz mais sentido, que eu deixo tudo organizado pro dia 02/10.</p>
    ...
    <p class="fineprint">Proposta de experiência da Elarah para a celebração dos 100 mil da Segatta Neuropsicologia — experiência de Cerâmica no Entre Mãos (Perdizes), em 02/10, das 16h às 19h30, para 8 participantes. Pacote Experiência R$ 439 por pessoa (R$ 3.512 · grupo de 8); Premium R$ 568 por pessoa (R$ 4.544), com mimo personalizado; Completo R$ 605,38 por pessoa (R$ 4.843), com mimo e registro profissional em vídeo. Valores para 8 participantes.</p>
