    ...
    <div class="bfeat" style="height:240px">
      ...
      <div class="bbody">
        ...
        <div class="dchips">
          ...
          <span>Bar, bartender &amp; insumos inclusos</span>
        </div>
      </div>
    </div>
...
planos = f'''
  <section class="slide">
    ...
    <table class="itable">
      <thead><tr>
        <th class="corner"></th>
        <th>A experiência<span>bar completo &amp; bartender</span></th>
        <th>Com foto &amp; coffee<span>+ foto profissional &amp; coffee break</span></th>
        <th class="hl"><span class="pill">★ Completo</span><br>Completo<span>+ personalização da noiva &amp; decoração</span></th>
      </tr></thead>
      <tbody><tr>
        <td class="rl"><b>Bartenderia</b><span>Bar, bartender e insumos inclusos</span></td>
        <td class="val">R$ 399</td><td class="val">R$ 499</td><td class="val hl">R$ 599</td>
      </tr></tbody>
    </table>

    <div class="note" style="margin-top:12px">◆ Valores <b>por pessoa</b>. Tanto as <b>experiências criativas</b> (a partir de R$ 229) quanto a <b>Bartenderia</b> (a partir de R$ 399) sobem de <b>R$ 100 em R$ 100</b> a cada extra: foto profissional &amp; coffee break, depois personalização da noiva &amp; decoração. Realizado em Jundiaí ou Itatiba, em novembro (data a combinar).</div>
    {foot("Investimento")}
  </section>'''
