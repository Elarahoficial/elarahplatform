# Folding Book · turma privada · ~10 pessoas · nov/dez (2a quinta 19:30) · espaco parceiro Pinheiros/Itaim/VO.
  ...
  <section class="slide">
    ...
    <div class="cover">
      <div>
        ...
        <p class="lead">Um encontro criativo e cheio de charme pro grupo: no <strong>Folding Book</strong>, cada convidado transforma as páginas de um livro em uma escultura linda — e leva pra casa a própria arte de recordação. Relaxante, delicado e diferente. 🌿</p>
        <div class="rule"></div>
        <div class="chips">
  ...
  <section class="slide">
    ...
    <div class="bfeat">
      ...
      <div class="bbody">
        ...
        <p>A gente leva o profissional, os livros e todo o material até o espaço parceiro. É só o grupo chegar e criar, entre boas conversas.</p>
        <ul class="feat">
    ...
    <div class="tiers">
      ...
      <div class="tier">
        ...
        <ul>
          ...
          <li>Com o nome de cada convidado</li>
        </ul>
      </div>
    </div>
...
proximos = f'''
  <section class="slide">
    ...
    <p class="lead">Me confirma a data (novembro ou dezembro, na 2ª quinta às 19:30), o plano e o número final de convidados, que a gente reserva a agenda e o espaço e organiza tudo — vocês só aproveitam. 🌿</p>
    <div class="rule"></div>
    <div class="grid3">
      <div class="infocard"><div class="ico">1️⃣</div><h3>Escolham</h3><p>A data, o plano e o número de convidados — me conta que eu já confirmo.</p></div>
      ...
      <div class="infocard"><div class="ico">3️⃣</div><h3>É só curtir</h3><p>No dia, chega tudo pronto no espaço. O grupo só cria e aproveita.</p></div>
    </div>
    <div class="quote">
