    ...
    <div class="cover">
      <div>
        ...
        <div class="chips">
          ...
          <span class="chip"><b>04</b> de setembro · tarde</span>
...
como = f'''
  <section class="slide">
    ...
    <div class="cta">
      ...
      <p>Me confirma a data (04 de setembro) e o número final de convidados, que a gente reserva o Bake Studio e fecha cada detalhe.</p>
    ...
    <p class="fineprint">Apresentação final da experiência corporativa da Elarah para o time de Design da Samsung, para 10 participantes, no dia 04 de setembro (período da tarde). Experiência confirmada: pintura em vidro, com cada convidado escolhendo o objeto a pintar (taça, xícara, copo, copo de cerveja, vaso, jarra ou moringa) e levando a peça pra casa. Formato Bake Studio: espaço exclusivo (cozinha e sala) só do time, com coffee break e foto profissional inclusos, a R$ 279 por pessoa — total de R$ 2.790 para 10 pessoas. Valor por pessoa, com material, condução e estrutura inclusos. Inclui +1h para o momento da empresa, sem custo adicional. Sujeito à confirmação da data (04 de setembro) e disponibilidade de agenda.</p>
