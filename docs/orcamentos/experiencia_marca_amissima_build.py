  ...
  <section class="slide">
    <div class="slide__head">
      ...
      <div class="head-right">
        ...
        <span class="compass"><img src="assets/amissima-logo.png" alt="Amissima" style="height:26px;width:auto;display:block;margin:2px 0 0 auto"><small>lançamento · Entre Mares</small></span>
      </div>
    </div>
    <div class="cover">
      <div>
