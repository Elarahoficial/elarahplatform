# Aniversário · Cerâmica + Pintura em cerâmica · 20 pessoas · final de novembro. 2 espaços (Betc + Bake Studio). Dusty blue.
import re
...
# ---- recolor: dusty blue (sereno, elegante) ----
head = head.replace("--orange:#F27623;", "--orange:#5B84A8;")
head = head.replace("--orange-dark:#D4600E;", "--orange-dark:#3E6285;")
head = head.replace("--navy:#16233C;", "--navy:#1F2C3A;")
head = head.replace("--navy-soft:#3B4E6B;", "--navy-soft:#56656F;")
head = head.replace("--blue-accent:#4C6EA3;", "--blue-accent:#5B84A8;")
head = head.replace("#EDF1F7", "#EDF1F6").replace("#DCE5F1", "#D8E2ED")
head = head.replace("#FF9A4D", "#8FB0CE")
head = head.replace("rgba(242,118,35,.22)", "rgba(91,132,168,.28)")
...
extra = '''
  ...
  .exp .top{position:absolute;top:11px;left:11px;z-index:3;background:var(--orange);color:#fff;font-size:9px;font-weight:700;letter-spacing:.05em;text-transform:uppercase;padding:5px 11px;border-radius:999px;box-shadow:0 6px 14px -4px rgba(62,98,133,.4)}
  ...
  <section class="slide">
    <div class="slide__head">
      ...
      <div class="head-right">
        ...
        <span class="compass">Aniversário <span>Elarah</span><small>Cerâmica &amp; pintura</small></span>
      </div>
    </div>
    <div class="cover">
      <div>
        <span class="eyebrow">✦ Aniversário · Cerâmica &amp; pintura em cerâmica</span>
        <h1>Comemorar<br>com as <em>mãos</em></h1>
        <p class="lead">Um aniversário diferente e cheio de charme: a galera se reúne pra um <strong>workshop de cerâmica ou pintura em cerâmica</strong>, onde cada um cria a própria peça e leva pra casa de recordação. Puro clima de celebração. 🥂</p>
        <div class="rule"></div>
        <div class="chips">
          <span class="chip"><b>20</b> pessoas</span>
          <span class="chip"><b>Final de novembro</b></span>
    ...
    {foot("Aniversário · Cerâmica &amp; pintura")}
  </section>'''
...
workshops = f'''
  <section class="slide">
    ...
    <p class="lead">Duas experiências criativas lindas pra escolher — <strong>pelo mesmo valor por pessoa</strong>. É só decidir a que mais combina com a turma (ou combinar as duas em estações). Cada um cria e leva a própria peça pra casa. 🎨</p>
    <div class="rule"></div>
    <div class="menu">
      {exp("01","ceramicamodelagem.jpg","Cerâmica","Modelar a argila à mão e criar uma peça única — relaxante, sensorial e cheio de charme.","Mãos modelando uma peça de cerâmica","center 50%")}
    ...
    <div class="note" style="margin-top:14px">◆ Os dois workshops têm o <b>mesmo valor por pessoa</b> — a escolha é da turma. Cada um leva a própria criação de recordação. 🎨</div>
    {foot("Os workshops")}
  </section>'''
...
planos = f'''
  <section class="slide">
    ...
    <p class="lead">Escolha o espaço e o nível que mais combinam. Valores por pessoa, com material e condução inclusos — e cada um sempre leva a própria peça de cerâmica. 🥂</p>
    <div class="rule"></div>
    ...
    <table class="itable">
      ...
      <tbody><tr>
        <td class="rl"><b>Cerâmica · Pintura em cerâmica</b><span>Os dois pelo mesmo valor</span></td>
    ...
    <table class="itable">
      ...
      <tbody><tr>
        <td class="rl"><b>Cerâmica · Pintura em cerâmica</b><span>Espaço só de vocês, com liberdade pra decorar</span></td>
...
personaliza = f'''
  <section class="slide">
    ...
    <p class="lead">Dois extras opcionais que deixam o aniversário ainda mais marcante — o registro profissional com voucher e a lembrancinha personalizada pra cada um.</p>
    <div class="rule"></div>
    <div class="plans">
      <div class="plan">
...
como = f'''
  <section class="slide">
    ...
    <div class="rule"></div>
    <div class="steps">
      <div class="step"><div class="num">1</div><h3>Escolham o workshop</h3><p>Cerâmica ou pintura em cerâmica — pelo mesmo valor. A gente leva profissional, material e estrutura.</p></div>
      ...
      <div class="step"><div class="num">3</div><h3>Cada um leva a arte</h3><p>No fim, todo mundo leva pra casa a própria peça — uma lembrança linda do dia. 🥂</p></div>
    </div>
    <div class="addon">
    ...
    <div class="cta">
      ...
      <p>Me confirma o workshop e o espaço que você prefere, que a gente fecha tudo pro final de novembro.</p>
    ...
    <p class="fineprint">Proposta de aniversário da Elarah — workshop de cerâmica ou pintura em cerâmica (pelo mesmo valor), para cerca de 20 pessoas, em final de novembro (data a combinar), em espaço parceiro. Cada participante cria e leva a própria peça. Opção 1 · Betc Havas Café (comida à parte): a partir de R$ 199 por pessoa (níveis R$ 199 / 299 / 399) — A experiência (material e condução) / + foto profissional e R$ 30 de voucher de consumo / Completo com lembrancinha. Opção 2 · Bake Studio (Bela Vista, cozinha e sala), espaço exclusivo com liberdade pra decorar: a partir de R$ 279 por pessoa; Completo por R$ 499 com foto profissional e lembrancinha. Valores por pessoa. Proposta válida mediante confirmação de data e disponibilidade de agenda.</p>
    {foot("Aniversário · Cerâmica &amp; pintura · 2026")}
  </section>'''

deck = '<div class="deck">\n' + cover + workshops + espacos + planos + personaliza + como + '\n\n</div>\n\n'
head = head.replace("<title>Setembro Amarelo · Elarah</title>", "<title>Aniversário · Cerâmica &amp; Pintura · Elarah</title>")
head = re.sub(r'<meta name="description" content="[^"]*">', '<meta name="description" content="Proposta de aniversário da Elarah — cerâmica ou pintura em cerâmica, no Betc Havas Café ou Bake Studio.">', head)
head = head.replace("</head>",
    ...
    "</style>\n</head>")
html = head + deck + tail
out = "/home/user/elarahplatform/experiencia-aniversario-ceramica-pintura.html"
