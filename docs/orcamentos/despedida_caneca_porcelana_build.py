...
head = head.replace("--orange:#F27623;", "--orange:#A83D5B;")
head = head.replace("--orange-dark:#D4600E;", "--orange-dark:#87304A;")
head = head.replace("--navy:#16233C;", "--navy:#33212A;")
head = head.replace("--navy-soft:#3B4E6B;", "--navy-soft:#6B5560;")
head = head.replace("--blue-accent:#4C6EA3;", "--blue-accent:#A83D5B;")
head = head.replace("#EDF1F7", "#FAEFF2").replace("#DCE5F1", "#F1DAE1")
head = head.replace("#FF9A4D", "#CE7C92")
head = head.replace("rgba(242,118,35,.22)", "rgba(168,61,91,.26)")
...
extra = '''
  ...
  .exp .top{position:absolute;top:11px;left:11px;z-index:3;background:var(--orange);color:#fff;font-size:9px;font-weight:700;letter-spacing:.05em;text-transform:uppercase;padding:5px 11px;border-radius:999px;box-shadow:0 6px 14px -4px rgba(135,48,74,.4)}
  ...
  <section class="slide">
    <div class="slide__head">
      ...
      <div class="head-right">
        <span class="kicker">Proposta de despedida de casamento</span>
        <span class="compass">Despedida <span>Elarah</span><small>Pintura em caneca</small></span>
      </div>
    </div>
    <div class="cover">
      <div>
        <span class="eyebrow">✦ Despedida de casamento · Pintura em caneca de porcelana</span>
        <h1>Uma despedida<br>que <em>fica</em></h1>
        <p class="lead">Uma tarde criativa e cheia de afeto pra celebrar a noiva com as amigas: um <strong>workshop de pintura em caneca de porcelana</strong>, onde cada uma personaliza a própria caneca e leva pra casa de lembrança. Puro clima de encontro, risada e brinde. ☕</p>
        <div class="rule"></div>
        <div class="chips">
          <span class="chip"><b>17</b> mulheres</span>
          <span class="chip"><b>22/08</b> · à tarde</span>
          <span class="chip">Em <b>espaço parceiro</b></span>
        </div>
      </div>
      <div class="cover-photo">
        <img src="assets/aniv-adulto.jpg" alt="Amigas felizes numa mesa decorada celebrando juntas" style="object-position:center 40%">
      </div>
    </div>
...
experiencias = f'''
  <section class="slide">
    ...
    <span class="eyebrow orange">◆ Pintura em caneca de porcelana</span>
    <h2>Cada caneca, <em>uma arte</em></h2>
    <p class="lead">Com tintas próprias pra porcelana, cada convidada cria a própria caneca — de flores delicadas a padrões coloridos, do jeitinho de cada uma. A gente leva o profissional, o material e toda a estrutura; vocês só chegam e pintam. ☕🎨</p>
    <div class="rule"></div>
    <div class="menu">
      {exp("01","xicarapintada.jpg","Cada caneca, única","Listras, cores e padrões — cada uma cria a própria caneca, do jeitinho dela.","Canecas de porcelana pintadas à mão com listras coloridas","center 50%")}
    ...
    <div class="note" style="margin-top:14px">◆ Estas são <b>inspirações</b> — na hora, cada convidada pinta a própria caneca, livre e do jeitinho dela, e leva pra casa de lembrança. ☕</div>
    {foot("O workshop")}
  </section>'''
...
espacos = f'''
  <section class="slide">
    ...
    <p class="lead">Duas cafeterias parceiras charmosas ou o Bake Studio, um estúdio exclusivo só das meninas. É só escolher qual combina mais com a despedida. ☕</p>
    <div class="rule"></div>
    <div class="vg">
      <div class="vgc">
...
planos = f'''
  <section class="slide">
    ...
    <p class="lead">Valores por pessoa, com material e condução inclusos — e cada uma sempre leva a própria caneca. É só escolher o espaço e o nível que mais combinam com a despedida. ☕</p>
    <div class="rule"></div>
    <table class="itable">
      <thead><tr>
        <th class="corner"></th>
...
como = f'''
  <section class="slide">
    ...
    <div class="rule"></div>
    <div class="steps">
      <div class="step"><div class="num">1</div><h3>Escolham o espaço</h3><p>Cafeteria parceira (Jules ou Betc Havas) ou o Bake Studio exclusivo só de vocês — a gente reserva pra turma no dia 22/08.</p></div>
      <div class="step"><div class="num">2</div><h3>A gente leva tudo</h3><p>Profissional, tintas, canecas de porcelana e toda a estrutura do workshop. Vocês só chegam e pintam.</p></div>
      <div class="step"><div class="num">3</div><h3>Cada uma leva a caneca</h3><p>No fim, todo mundo leva pra casa a própria caneca pintada — uma lembrança linda da despedida. ☕</p></div>
    </div>
    <div class="addon">
      <span class="plus">+</span>
      <div>
        <h4>Sob medida pro dia da noiva</h4>
    ...
    <div class="cta">
      ...
      <p>Me confirma o espaço e o nível, que a gente reserva tudo pra despedida no dia 22/08 à tarde.</p>
      <div class="cta-actions">
        <a class="btn-wa" href="https://wa.me/5511914455930?text=Oi%2C%20Elarah!%20Vi%20a%20proposta%20da%20despedida%20com%20pintura%20em%20caneca%20e%20quero%20fechar%20os%20detalhes." target="_blank" rel="noopener">
          💬 Falar no WhatsApp
        </a>
    ...
    <p class="fineprint">Proposta de despedida de casamento da Elarah — workshop de pintura em caneca de porcelana, para cerca de 17 mulheres, no dia 22/08 à tarde (a combinar), em espaço parceiro em SP. Cada convidada pinta e leva a própria caneca. Valores por pessoa. No Jules · Campo Belo: A experiência R$ 199 / Com foto R$ 299 / Completo R$ 399 com lembrancinha. No Betc Havas Café (já com R$ 50 de voucher de consumo): A experiência R$ 249 / Com foto R$ 349 / Completo R$ 449 com lembrancinha. No Bake Studio (espaço exclusivo, experiência + espaço só de vocês): A experiência R$ 289 / Com foto R$ 389 (com foto profissional e coffee break) / Completo R$ 539 com decoração e lembrancinha. Valores por pessoa. Proposta válida mediante confirmação de data e disponibilidade de agenda.</p>
    {foot("Despedida de casamento · 2026")}
  </section>'''

deck = '<div class="deck">\n' + cover + experiencias + espacos + planos + personaliza + como + '\n\n</div>\n\n'
head = head.replace("<title>Setembro Amarelo · Elarah</title>", "<title>Despedida · Pintura em Caneca · Elarah</title>")
head = re.sub(r'<meta name="description" content="[^"]*">', '<meta name="description" content="Proposta da Elarah — despedida de casamento com pintura em caneca de porcelana, no café ou no Bake Studio.">', head)
head = head.replace("</head>",
    ...
    "</style>\n</head>")
html = head + deck + tail
out = "/home/user/elarahplatform/experiencia-despedida-caneca.html"
