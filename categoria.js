document.addEventListener('DOMContentLoaded', async () => {
  ...
  function createCardEl(exp) {
    ...
    const CATEGORY_DEFAULT_IMG = {
      ...
      'tufting e punch': 'assets/tufting1.jpg',
    ...
    // Selo de escassez (regra honesta de ElarahData). Atividade semanal não
    // leva selo — a turma se repete toda semana. Nas pontuais, só aparece
    // quando TODA data futura está enchendo, e mostra o nº da data mais
    // folgada: um dia com 1 vaga não estampa "última vaga" no card se
